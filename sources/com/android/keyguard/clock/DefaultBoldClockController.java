...
public class DefaultBoldClockController implements ClockPlugin {
    ...
    public DefaultBoldClockController(Resources resources, LayoutInflater layoutInflater, SysuiColorExtractor sysuiColorExtractor) {
    ...
    private void createViews() {
        ...
        textClock.setFormat12Hour(Html.fromHtml("<strong>h</strong>:mm"));
        this.mClock.setFormat24Hour(Html.fromHtml("<strong>kk</strong>:mm"));
    }
    ...
    public String getTitle() {
        return this.mResources.getString(R.string.clock_title_default_bold);
    }

    @Override // com.android.systemui.plugins.ClockPlugin
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(this.mResources, R.drawable.default_bold_thumbnail);
    }
    ...
    public Bitmap getPreview(int i, int i2) {
        ...
        textClock.setFormat12Hour(Html.fromHtml("<strong>h</strong>:mm"));
        textClock.setFormat24Hour(Html.fromHtml("<strong>kk</strong>:mm"));
