...
public final class ClockOptionsProvider extends ContentProvider {
    ...
    public ClockOptionsProvider() {
        this(new Supplier() { // from class: com.android.keyguard.clock.ClockOptionsProvider$$ExternalSyntheticLambda0
    ...
    private static class MyWriter implements ContentProvider.PipeDataWriter<Bitmap> {
        ...
        public void writeDataToPipe(ParcelFileDescriptor parcelFileDescriptor, Uri uri, String str, Bundle bundle, Bitmap bitmap) throws IOException {
            try {
