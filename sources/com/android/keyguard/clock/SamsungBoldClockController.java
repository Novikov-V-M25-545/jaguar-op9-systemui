...
public class SamsungBoldClockController implements ClockPlugin {
    ...
    public SamsungBoldClockController(Resources resources, LayoutInflater layoutInflater, SysuiColorExtractor sysuiColorExtractor) {
    ...
    private void createViews() {
        ...
        this.mClock.setFormat12Hour(Html.fromHtml("<strong>hh</strong><br>mm"));
        this.mClock.setFormat24Hour(Html.fromHtml("<strong>kk</strong><br>mm"));
    }
    ...
    public String getTitle() {
        return this.mResources.getString(R.string.clock_title_samsung_bold);
    }

    @Override // com.android.systemui.plugins.ClockPlugin
    public Bitmap getThumbnail() {
        return BitmapFactory.decodeResource(this.mResources, R.drawable.samsung_bold_thumbnail);
    }
    ...
    public Bitmap getPreview(int i, int i2) {
        ...
        textClock.setLineSpacing(0.0f, 0.8f);
        textClock.setFormat12Hour(Html.fromHtml("<strong>hh</strong><br>mm"));
        textClock.setFormat24Hour(Html.fromHtml("<strong>kk</strong><br>mm"));
