...
public class AndroidSDP3ClockController implements ClockPlugin {
    ...
    private final float mTextSizeNormal = 48.0f;
    private final float mSliceTextSize = 20.0f;
    private final float mTitleTextSize = 24.0f;
    private float clockDividY = 5.0f;
    ...
    public AndroidSDP3ClockController(Resources resources, LayoutInflater layoutInflater, SysuiColorExtractor sysuiColorExtractor) {
    ...
    private void createViews() {
        ClockLayout clockLayout = (ClockLayout) this.mLayoutInflater.inflate(R.layout.android_s_dp3_clock, (ViewGroup) null);
        ...
        textClock2.setTextSize(resources.getDimensionPixelSize(i) * 1.5f);
        ...
        this.mRowTextSize = this.mContext.getResources().getDimensionPixelSize(i);
    ...
    public String getTitle() {
        return this.mResources.getString(R.string.clock_title_android_s_dp3);
    }
    ...
    public Bitmap getPreview(int i, int i2) {
        ...
        TextClock textClock = (TextClock) this.mView.findViewById(R.id.clock);
    ...
    public void setSlice(Slice slice) {
        ...
        for (?? r8 = this.mHasHeader; r8 < size; r8++) {
            ...
            if (sliceItemFind != null) {
                int iDpToPx = Converter.dpToPx(this.mContext, 16);
    ...
    public void setDarkAmount(float f) {
        ...
        while (true) {
            ...
            if (i < this.mRow.getChildCount()) {
                ...
                this.mTitle.setTextSize((8.0f * f) + 24.0f);
