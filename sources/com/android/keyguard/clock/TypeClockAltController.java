...
public class TypeClockAltController implements ClockPlugin {
    ...
    private void createViews() {
        View viewInflate = this.mLayoutInflater.inflate(R.layout.type_clock_alt, (ViewGroup) null);
        this.mView = viewInflate;
        this.mTypeClock = (TypographicClock) viewInflate.findViewById(R.id.type_clock);
        TypographicClock typographicClock = (TypographicClock) this.mLayoutInflater.inflate(R.layout.typographic_clock_alt, (ViewGroup) null);
    ...
    public String getTitle() {
        return this.mResources.getString(R.string.clock_title_type_alt);
    }
