...
public class PasswordTextView extends View {
    ...
    public PasswordTextView(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        try {
            this.mTextHeightRaw = typedArrayObtainStyledAttributes.getInt(R.styleable.PasswordTextView_scaledTextSize, 0);
            this.mGravity = typedArrayObtainStyledAttributes.getInt(R.styleable.PasswordTextView_android_gravity, 17);
            this.mDotSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.PasswordTextView_dotSize, getContext().getResources().getDimensionPixelSize(R.dimen.password_dot_size));
            this.mCharPadding = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.PasswordTextView_charPadding, getContext().getResources().getDimensionPixelSize(R.dimen.password_char_padding));
            paint.setColor(typedArrayObtainStyledAttributes.getColor(R.styleable.PasswordTextView_android_textColor, -1));
            typedArrayObtainStyledAttributes.recycle();
            paint.setFlags(129);
            paint.setTextAlign(Paint.Align.CENTER);
            paint.setTypeface(Typeface.create(context.getString(android.R.string.config_defaultCredentialManagerAutofillService), 0));
            this.mShowPassword = Settings.System.getInt(((View) this).mContext.getContentResolver(), "show_password", 1) == 1;
            this.mAppearInterpolator = AnimationUtils.loadInterpolator(((View) this).mContext, android.R.interpolator.linear_out_slow_in);
            this.mDisappearInterpolator = AnimationUtils.loadInterpolator(((View) this).mContext, android.R.interpolator.fast_out_linear_in);
            this.mFastOutSlowInInterpolator = AnimationUtils.loadInterpolator(((View) this).mContext, android.R.interpolator.fast_out_slow_in);
    ...
    private class CharState {
        ...
        private void startWidthDisappearAnimation(long j) {
            cancelAnimator(this.widthAnimator);
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.currentWidthFactor, 0.0f);
            this.widthAnimator = valueAnimatorOfFloat;
            valueAnimatorOfFloat.addUpdateListener(this.widthUpdater);
        ...
        private void startTextDisappearAnimation(long j) {
            ...
            valueAnimatorOfFloat.addUpdateListener(this.textSizeUpdater);
        ...
        private void startWidthAppearAnimation() {
            cancelAnimator(this.widthAnimator);
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.currentWidthFactor, 1.0f);
            this.widthAnimator = valueAnimatorOfFloat;
            valueAnimatorOfFloat.addUpdateListener(this.widthUpdater);
            this.widthAnimator.addListener(this.widthFinishListener);
        ...
        private void startTextAppearAnimation() {
            cancelAnimator(this.textAnimator);
            ValueAnimator valueAnimatorOfFloat = ValueAnimator.ofFloat(this.currentTextSizeFactor, 1.0f);
            this.textAnimator = valueAnimatorOfFloat;
            valueAnimatorOfFloat.addUpdateListener(this.textSizeUpdater);
            this.textAnimator.addListener(this.textFinishListener);
            ...
            if (this.textTranslateAnimator == null) {
                ...
                this.textTranslateAnimator = valueAnimatorOfFloat2;
                valueAnimatorOfFloat2.addUpdateListener(this.textTranslationUpdater);
        ...
        private void startDotAppearAnimation(long j) {
            ...
            if (!PasswordTextView.this.mShowPassword) {
                ...
                valueAnimatorOfFloat3.setDuration((long) ((1.0f - this.currentDotSizeFactor) * 160.0f));
