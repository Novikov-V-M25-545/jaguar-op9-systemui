...
public class CachedBluetoothDeviceManager {
    ...
    public CachedBluetoothDevice addDevice(BluetoothDevice bluetoothDevice) {
        ...
        synchronized (this) {
            cachedBluetoothDeviceFindDevice = findDevice(bluetoothDevice);
            if (cachedBluetoothDeviceFindDevice == null) {
                cachedBluetoothDeviceFindDevice = new CachedBluetoothDevice(this.mContext, profileManager, bluetoothDevice);
                ...
                if (!this.mHearingAidDeviceManager.setSubDeviceIfNeeded(cachedBluetoothDeviceFindDevice)) {
                    this.mCachedDevices.add(cachedBluetoothDeviceFindDevice);
                    this.mBtManager.getEventManager().dispatchDeviceAdded(cachedBluetoothDeviceFindDevice);
                }
            }
        }
    ...
    public synchronized void onDeviceUnpaired(CachedBluetoothDevice cachedBluetoothDevice) {
        CachedBluetoothDevice cachedBluetoothDeviceFindMainDevice = this.mHearingAidDeviceManager.findMainDevice(cachedBluetoothDevice);
        CachedBluetoothDevice subDevice = cachedBluetoothDevice.getSubDevice();
        if (subDevice != null) {
            subDevice.unpair();
            cachedBluetoothDevice.setSubDevice(null);
            ...
            cachedBluetoothDeviceFindMainDevice.setSubDevice(null);
        }
    }
}
