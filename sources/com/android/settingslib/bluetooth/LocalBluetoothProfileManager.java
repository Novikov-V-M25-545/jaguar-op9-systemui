...
public class LocalBluetoothProfileManager {
    ...
    void updateLocalProfiles() {
        ...
        if (this.mBCProfile == null && supportedProfiles.contains(24)) {
            try {
    ...
    private class StateChangedHandler implements BluetoothEventManager.Handler {
        ...
        public void onReceive(Context context, Intent intent, BluetoothDevice bluetoothDevice) {
            ...
            if (cachedBluetoothDeviceFindDevice == null) {
                ...
                cachedBluetoothDeviceFindDevice = LocalBluetoothProfileManager.this.mDeviceManager.addDevice(bluetoothDevice);
            }
    ...
    synchronized void updateProfiles(ParcelUuid[] parcelUuidArr, ParcelUuid[] parcelUuidArr2, Collection<LocalBluetoothProfile> collection, Collection<LocalBluetoothProfile> collection2, boolean z, BluetoothDevice bluetoothDevice) {
        ...
        LocalBluetoothProfile localBluetoothProfile = this.mBCProfile;
        if (localBluetoothProfile != null) {
            collection.add(localBluetoothProfile);
