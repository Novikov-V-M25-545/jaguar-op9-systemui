...
public class HidProfile implements LocalBluetoothProfile {
        ...
        public void onServiceConnected(int i, BluetoothProfile bluetoothProfile) {
            ...
            while (!connectedDevices.isEmpty()) {
                ...
                if (cachedBluetoothDeviceFindDevice == null) {
                    ...
                    cachedBluetoothDeviceFindDevice = HidProfile.this.mDeviceManager.addDevice(bluetoothDevice);
                }
    ...
    public int getDrawableResource(BluetoothClass bluetoothClass) {
        return bluetoothClass == null ? R.drawable.ic_doc_folder : getHidClassDrawable(bluetoothClass);
    }

    public static int getHidClassDrawable(BluetoothClass bluetoothClass) {
        int deviceClass = bluetoothClass.getDeviceClass();
        return deviceClass != 1344 ? deviceClass != 1408 ? deviceClass != 1472 ? R.drawable.fastscroll_track_default_holo_light : R.drawable.ic_doc_folder : R.drawable.fastscroll_track_holo_light : R.drawable.ic_doc_folder;
    }
