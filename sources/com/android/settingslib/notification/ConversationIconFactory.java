...
public class ConversationIconFactory extends BaseIconFactory {
    ...
    static {
        float fSqrt = (float) Math.sqrt(288.0d);
        INN_CIRCLE_DIA = fSqrt;
        float f = fSqrt / 2.0f;
        INN_CIRCLE_RAD = f;
        CIRCLE_RADIUS = f + ((10.0f - f) / 2.0f);
        RING_STROKE_WIDTH = (20.0f - fSqrt) / 2.0f;
    }
    ...
    public static class ConversationIconDrawable extends Drawable {
        ...
        public void draw(Canvas canvas) {
            float fWidth = getBounds().width() / 56.0f;
            int i = (int) (52.0f * fWidth);
            int i2 = (int) (40.0f * fWidth);
            int i3 = (int) (46.0f * fWidth);
            float f = (int) (ConversationIconFactory.RING_STROKE_WIDTH * fWidth);
            this.mPaddingPaint.setStrokeWidth(f);
            float f2 = (int) (ConversationIconFactory.CIRCLE_RADIUS * fWidth);
