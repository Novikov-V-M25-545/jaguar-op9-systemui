...
public final class Estimate {
    ...
    public static final class Companion {
        ...
        public final Estimate getCachedEstimateIfAvailable(@NotNull Context context) {
            ...
            long j = -1;
            return new Estimate(Settings.Global.getLong(contentResolver, "time_remaining_estimate_millis", j), Settings.Global.getInt(contentResolver, "time_remaining_estimate_based_on_usage", 0) == 1, Settings.Global.getLong(contentResolver, "average_time_to_discharge", j));
        }
