...
public class Utils {
    ...
    static final int[] WIFI_PIE = {R.drawable.ic_perm_group_bluetooth, R.drawable.ic_perm_group_bookmarks, R.drawable.ic_perm_group_calendar, R.drawable.ic_perm_group_camera, R.drawable.ic_perm_group_device_alarms};
    ...
    public static ColorStateList getColorError(Context context) {
        return getColorAttr(context, R.attr.colorError);
    }

    public static int getColorAccentDefaultColor(Context context) {
        return getColorAttrDefaultColor(context, R.attr.colorAccent);
    }

    public static int getColorErrorDefaultColor(Context context) {
        return getColorAttrDefaultColor(context, R.attr.colorError);
    }
    ...
    public static boolean isDeviceProvisioningPackage(Resources resources, String str) throws Resources.NotFoundException {
        String string = resources.getString(R.string.config_customResolverActivity);
    ...
    public static Drawable getBadgedIcon(Context context, Drawable drawable, UserHandle userHandle) {
        ...
        try {
            BitmapDrawable bitmapDrawable = new BitmapDrawable(context.getResources(), iconFactoryObtain.createBadgedIconBitmap(drawable, userHandle, true).icon);
    ...
    public static Bitmap convertCornerRadiusBitmap(Context context, Bitmap bitmap, float f) {
        ...
        roundedBitmapDrawableCreate.setBounds(0, 0, canvas.getWidth(), canvas.getHeight());
