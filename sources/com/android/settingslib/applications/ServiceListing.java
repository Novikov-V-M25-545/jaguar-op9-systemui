...
public class ServiceListing {
    ...
    public void reload() {
        ...
        Iterator<ComponentName> it2 = this.mEnabledServices.iterator();
        while (it2.hasNext()) {
            Iterator it3 = packageManager.queryIntentServicesAsUser(new Intent().setComponent(it2.next()), i, currentUser).iterator();
            while (it3.hasNext()) {
        ...
        while (it4.hasNext()) {
            it4.next().onServicesReloaded(this.mServices);
        }
    }
    ...
    public static class Builder {
        ...
        public ServiceListing build() {
            return new ServiceListing(this.mContext, this.mTag, this.mSetting, this.mIntentAction, this.mPermission, this.mNoun, this.mAddDeviceLockedFlags, this.mValidator);
        }
    }
}
