...
public class TunerSwitch extends SwitchPreference implements TunerService.Tunable {
    ...
    public TunerSwitch(Context context, AttributeSet attributeSet) {
        ...
        this.mDefault = typedArrayObtainStyledAttributes.getBoolean(R.styleable.TunerSwitch_defValue, false);
        this.mAction = typedArrayObtainStyledAttributes.getInt(R.styleable.TunerSwitch_metricsAction, -1);
    }
