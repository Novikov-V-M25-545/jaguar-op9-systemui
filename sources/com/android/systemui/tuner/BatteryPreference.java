...
public class BatteryPreference extends DropDownPreference implements TunerService.Tunable {
    ...
    public BatteryPreference(Context context, AttributeSet attributeSet) {
        ...
        this.mBattery = context.getString(R.string.permlab_foregroundServiceMediaProjection);
    ...
    public void onAttached() {
        super.onAttached();
        this.mHasPercentage = Settings.System.getInt(getContext().getContentResolver(), "dummy_show_battery_percent", 0) != 0;
    ...
    public void onTuningChanged(String str, String str2) {
        if ("icon_blacklist".equals(str)) {
            this.mBlacklist = StatusBarIconController.getIconBlacklist(getContext(), str2);
    ...
    protected boolean persistString(String str) {
        ...
        Settings.System.putInt(getContext().getContentResolver(), "dummy_show_battery_percent", zEquals ? 1 : 0);
