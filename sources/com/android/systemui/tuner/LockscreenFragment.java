...
public class LockscreenFragment extends PreferenceFragment {
    ...
    private void setupGroup(String str, String str2) {
        ...
        addTunable(new TunerService.Tunable() { // from class: com.android.systemui.tuner.LockscreenFragment$$ExternalSyntheticLambda0
            ...
            public final void onTuningChanged(String str3, String str4) {
                this.f$0.lambda$setupGroup$1(switchPreference, preferenceFindPreference, str3, str4);
            }
        }, str);
    }
        ...
        public void toggleExpando(final Adapter adapter) {
            ...
            if (z) {
                this.mChildren.forEach(new Consumer() { // from class: com.android.systemui.tuner.LockscreenFragment$App$$ExternalSyntheticLambda1
                    @Override // java.util.function.Consumer
                    public final void accept(Object obj) {
                        this.f$0.lambda$toggleExpando$0(adapter, (LockscreenFragment.Item) obj);
                    }
                });
            } else {
    ...
    private static class ShortcutButton implements IntentButtonProvider.IntentButton {
        ...
        public ShortcutButton(Context context, ShortcutParser.Shortcut shortcut) {
            ...
            int iApplyDimension = (int) TypedValue.applyDimension(1, 32.0f, context.getResources().getDisplayMetrics());
            iconState.drawable = new ScalingDrawableWrapper(iconState.drawable, iApplyDimension / r4.getIntrinsicWidth());
    ...
    private static class ActivityButton implements IntentButtonProvider.IntentButton {
        ...
        public ActivityButton(Context context, ActivityInfo activityInfo) {
            ...
            int iApplyDimension = (int) TypedValue.applyDimension(1, 32.0f, context.getResources().getDisplayMetrics());
            iconState.drawable = new ScalingDrawableWrapper(iconState.drawable, iApplyDimension / r6.getIntrinsicWidth());
            iconState.tint = false;
        }
