...
public class DependencyProvider {
    ...
    public PulseController providePulseController(Context context, Handler handler, Executor executor) {
        return new PulseControllerImpl(context, handler, executor);
    }
}
