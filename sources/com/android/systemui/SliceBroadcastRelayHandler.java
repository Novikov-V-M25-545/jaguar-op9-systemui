...
public class SliceBroadcastRelayHandler extends SystemUI {
    ...
    public SliceBroadcastRelayHandler(Context context, BroadcastDispatcher broadcastDispatcher) {
        super(context);
        this.mRelays = new ArrayMap<>();
        this.mReceiver = new BroadcastReceiver() { // from class: com.android.systemui.SliceBroadcastRelayHandler.1
    ...
    void handleIntent(Intent intent) {
        ...
        if ("com.android.settingslib.action.REGISTER_SLICE_RECEIVER".equals(intent.getAction())) {
            ...
            if (!"com.android.settingslib.action.UNREGISTER_SLICE_RECEIVER".equals(intent.getAction()) || (andRemoveRelay = getAndRemoveRelay((Uri) intent.getParcelableExtra("uri"))) == null) {
                return;
            }
