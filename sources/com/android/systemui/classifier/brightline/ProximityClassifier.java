...
class ProximityClassifier extends FalsingClassifier {
    ...
    public void onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 1 || actionMasked == 3) {
            ...
            if (eventTimeNano == 0) {
                ...
                this.mPercentNear = this.mNearDurationNs / eventTimeNano;
            }
        }
    }
    ...
    public void onProximityEvent(ThresholdSensor.ThresholdSensorEvent thresholdSensorEvent) {
        boolean below = thresholdSensorEvent.getBelow();
        long timestampNs = thresholdSensorEvent.getTimestampNs();
        FalsingClassifier.logDebug("Sensor is: " + below + " at time " + timestampNs);
        update(below, timestampNs);
    }
