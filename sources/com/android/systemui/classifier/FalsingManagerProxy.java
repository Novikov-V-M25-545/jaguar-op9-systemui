...
public class FalsingManagerProxy implements FalsingManager, Dumpable {
    ...
    FalsingManagerProxy(final Context context, PluginManager pluginManager, Executor executor, ProximitySensor proximitySensor, DeviceConfigProxy deviceConfigProxy, DockManager dockManager, KeyguardUpdateMonitor keyguardUpdateMonitor, DumpManager dumpManager, Executor executor2, StatusBarStateController statusBarStateController, FalsingDataProvider falsingDataProvider) {
        ...
        this.mDeviceConfigListener = new DeviceConfig.OnPropertiesChangedListener() { // from class: com.android.systemui.classifier.FalsingManagerProxy$$ExternalSyntheticLambda0
            public final void onPropertiesChanged(DeviceConfig.Properties properties) {
                this.f$0.lambda$new$0(context, properties);
            }
        };
        setupFalsingManager(context);
        deviceConfigProxy.addOnPropertiesChangedListener("systemui", executor, this.mDeviceConfigListener);
    ...
    public /* synthetic */ void lambda$new$0(Context context, DeviceConfig.Properties properties) {
    ...
    private void setupFalsingManager(Context context) {
        boolean z = this.mDeviceConfig.getBoolean("systemui", "brightline_falsing_manager_enabled", context.getResources().getBoolean(R.bool.config_lockscreenAntiFalsingClassifierEnabled));
        if (z != this.mBrightlineEnabled || this.mInternalFalsingManager == null) {
            ...
            if (!z) {
                ...
                this.mInternalFalsingManager = new BrightLineFalsingManager(this.mFalsingDataProvider, this.mKeyguardUpdateMonitor, this.mProximitySensor, this.mDeviceConfig, this.mDockManager, this.mStatusBarStateController);
            }
        }
    }
