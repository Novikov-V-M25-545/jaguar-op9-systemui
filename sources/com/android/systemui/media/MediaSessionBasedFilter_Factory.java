...
public final class MediaSessionBasedFilter_Factory implements Factory<MediaSessionBasedFilter> {
    ...
    public MediaSessionBasedFilter get() {
        return provideInstance(this.contextProvider, this.sessionManagerProvider, this.foregroundExecutorProvider, this.backgroundExecutorProvider);
    }

    public static MediaSessionBasedFilter provideInstance(Provider<Context> provider, Provider<MediaSessionManager> provider2, Provider<Executor> provider3, Provider<Executor> provider4) {
        return new MediaSessionBasedFilter(provider.get(), provider2.get(), provider3.get(), provider4.get());
    }
