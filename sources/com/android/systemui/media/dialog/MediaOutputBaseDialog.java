...
public abstract class MediaOutputBaseDialog extends SystemUIDialog implements MediaOutputController.Callback {
    ...
    public MediaOutputBaseDialog(Context context, MediaOutputController mediaOutputController) {
        ...
        this.mDeviceListLayoutListener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.android.systemui.media.dialog.MediaOutputBaseDialog$$ExternalSyntheticLambda3
    ...
    public void lambda$onRouteChanged$5() throws Resources.NotFoundException {
        refresh(false);
    }

    void refresh(boolean z) throws Resources.NotFoundException {
    ...
    public void onMediaChanged() {
        this.mMainThreadHandler.post(new Runnable() { // from class: com.android.systemui.media.dialog.MediaOutputBaseDialog$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() throws Resources.NotFoundException {
                this.f$0.lambda$onMediaChanged$4();
            }
        });
    }
    ...
    public void onRouteChanged() {
        this.mMainThreadHandler.post(new Runnable() { // from class: com.android.systemui.media.dialog.MediaOutputBaseDialog$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() throws Resources.NotFoundException {
                this.f$0.lambda$onRouteChanged$5();
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$onDeviceListChanged$6() throws Resources.NotFoundException {
        refresh(true);
    }
    ...
    public void onDeviceListChanged() {
        this.mMainThreadHandler.post(new Runnable() { // from class: com.android.systemui.media.dialog.MediaOutputBaseDialog$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() throws Resources.NotFoundException {
                this.f$0.lambda$onDeviceListChanged$6();
            }
        });
    }
