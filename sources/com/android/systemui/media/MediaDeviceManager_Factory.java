...
public final class MediaDeviceManager_Factory implements Factory<MediaDeviceManager> {
    ...
    public MediaDeviceManager get() {
        return provideInstance(this.controllerFactoryProvider, this.localMediaManagerFactoryProvider, this.mr2managerProvider, this.fgExecutorProvider, this.bgExecutorProvider, this.dumpManagerProvider);
    }

    public static MediaDeviceManager provideInstance(Provider<MediaControllerFactory> provider, Provider<LocalMediaManagerFactory> provider2, Provider<MediaRouter2Manager> provider3, Provider<Executor> provider4, Provider<Executor> provider5, Provider<DumpManager> provider6) {
