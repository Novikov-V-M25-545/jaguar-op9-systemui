...
public class ResumeMediaBrowser {
    ...
    private final MediaBrowser.ConnectionCallback mConnectionCallback = new MediaBrowser.ConnectionCallback() { // from class: com.android.systemui.media.ResumeMediaBrowser.2
        ...
        public void onConnected() {
            ...
            if (ResumeMediaBrowser.this.mMediaBrowser != null && ResumeMediaBrowser.this.mMediaBrowser.isConnected()) {
                ...
                if (!TextUtils.isEmpty(root) && ResumeMediaBrowser.this.mMediaBrowser != null) {
    ...
    public ResumeMediaBrowser(Context context, Callback callback, ComponentName componentName, MediaBrowserFactory mediaBrowserFactory, int i) {
    ...
    public void findRecentMedia() {
        ...
        MediaBrowser mediaBrowserCreate = this.mBrowserFactory.create(this.mComponentName, this.mConnectionCallback, bundle);
        this.mMediaBrowser = mediaBrowserCreate;
        mediaBrowserCreate.connect();
    }
    ...
    public void restart() {
        ...
        Bundle bundle = new Bundle();
        bundle.putBoolean("android.service.media.extra.RECENT", true);
        MediaBrowser mediaBrowserCreate = this.mBrowserFactory.create(this.mComponentName, new MediaBrowser.ConnectionCallback() { // from class: com.android.systemui.media.ResumeMediaBrowser.3
            @Override // android.media.browse.MediaBrowser.ConnectionCallback
            public void onConnected() {
