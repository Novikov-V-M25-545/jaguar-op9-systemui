...
public class KeyboardUI extends SystemUI implements InputManager.OnTabletModeChangedListener {
    ...
    public void init() {
        ...
        String string = context.getString(R.string.config_defaultTrustAgent);
    ...
    public CachedBluetoothDevice getCachedBluetoothDevice(BluetoothDevice bluetoothDevice) {
        ...
        return cachedBluetoothDeviceFindDevice == null ? this.mCachedDeviceManager.addDevice(bluetoothDevice) : cachedBluetoothDeviceFindDevice;
    }
