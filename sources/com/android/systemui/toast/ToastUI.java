...
public class ToastUI extends SystemUI implements CommandQueue.Callbacks {
    ...
    ToastUI(Context context, CommandQueue commandQueue, INotificationManager iNotificationManager, IAccessibilityManager iAccessibilityManager) {
        ...
        this.mGravity = resources.getInteger(R.integer.config_minNumVisibleRecentTasks);
        this.mY = resources.getDimensionPixelSize(R.dimen.notification_verification_icon_size);
    }
    ...
    public void showToast(int i, String str, IBinder iBinder, CharSequence charSequence, IBinder iBinder2, int i2, ITransientNotificationCallback iTransientNotificationCallback) {
        ...
        Context contextCreateContextAsUser = this.mContext.createContextAsUser(UserHandle.getUserHandleForUid(i), 0);
        View textToastView = ToastPresenter.getTextToastView(contextCreateContextAsUser, charSequence);
        this.mCallback = iTransientNotificationCallback;
        ToastPresenter toastPresenter = new ToastPresenter(contextCreateContextAsUser, this.mAccessibilityManager, this.mNotificationManager, str);
