...
public abstract class RecentsModule {
    public static RecentsImplementation provideRecentsImpl(Context context, ContextComponentHelper contextComponentHelper) {
        ...
        RecentsImplementation recentsImplementationResolveRecents = contextComponentHelper.resolveRecents(string);
        if (recentsImplementationResolveRecents != null) {
            return recentsImplementationResolveRecents;
        }
        try {
            try {
