...
public class PipControlButtonView extends RelativeLayout {
    ...
    public void onFinishInflate() throws Resources.NotFoundException {
        ...
        this.mTextFocusGainAnimator = animatorLoadAnimator;
        animatorLoadAnimator.setTarget(this.mDescriptionTextView);
        Animator animatorLoadAnimator2 = AnimatorInflater.loadAnimator(getContext(), i);
        this.mButtonFocusGainAnimator = animatorLoadAnimator2;
        animatorLoadAnimator2.setTarget(this.mButtonImageView);
        Context context2 = getContext();
        int i2 = R.anim.tv_pip_controls_focus_loss_animation;
        Animator animatorLoadAnimator3 = AnimatorInflater.loadAnimator(context2, i2);
        this.mTextFocusLossAnimator = animatorLoadAnimator3;
        animatorLoadAnimator3.setTarget(this.mDescriptionTextView);
        Animator animatorLoadAnimator4 = AnimatorInflater.loadAnimator(getContext(), i2);
        this.mButtonFocusLossAnimator = animatorLoadAnimator4;
        animatorLoadAnimator4.setTarget(this.mButtonImageView);
    }
