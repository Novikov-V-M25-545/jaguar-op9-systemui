...
public class PipMediaController {
    ...
    public PipMediaController(Context context, IActivityManager iActivityManager, BroadcastDispatcher broadcastDispatcher) {
        ...
        ((UserInfoController) Dependency.get(UserInfoController.class)).addCallback(new UserInfoController.OnUserInfoChangedListener() { // from class: com.android.systemui.pip.phone.PipMediaController$$ExternalSyntheticLambda0
            @Override // com.android.systemui.statusbar.policy.UserInfoController.OnUserInfoChangedListener
            public final void onUserInfoChanged(String str, Drawable drawable, String str2) {
                this.f$0.lambda$new$0(str, drawable, str2);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(String str, Drawable drawable, String str2) {
    ...
    public void notifyActionsChanged() {
        ...
        this.mListeners.forEach(new Consumer() { // from class: com.android.systemui.pip.phone.PipMediaController$$ExternalSyntheticLambda1
