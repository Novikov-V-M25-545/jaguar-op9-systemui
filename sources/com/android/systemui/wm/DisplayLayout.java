...
public class DisplayLayout {
    ...
    static void computeNonDecorInsets(Resources resources, int i, int i2, int i3, DisplayCutout displayCutout, int i4, Rect rect, boolean z) {
        ...
        if (z) {
            ...
            int navigationBarSize = getNavigationBarSize(resources, iNavigationBarPosition, i2 > i3, i4);
    ...
    static int getStatusBarHeight(boolean z, Resources resources) {
        if (z) {
            return resources.getDimensionPixelSize(R.dimen.notification_custom_view_max_image_height_low_ram);
        }
        return resources.getDimensionPixelSize(R.dimen.notification_custom_view_max_image_width);
    }
    ...
    public static DisplayCutout calculateDisplayCutoutForRotation(DisplayCutout displayCutout, int i, int i2, int i3) {
        ...
        Insets insetsRotateInsets = RotationUtils.rotateInsets(displayCutout.getWaterfallInsets(), i);
        if (i == 0) {
        ...
        DisplayCutout displayCutoutFromBoundsAndWaterfall = DisplayCutout.fromBoundsAndWaterfall(rectArr, insetsRotateInsets);
        int i5 = z ? i3 : i2;
        if (!z) {
            i2 = i3;
        }
        return computeSafeInsets(displayCutoutFromBoundsAndWaterfall, i5, i2);
    }
    ...
    static boolean hasNavigationBar(DisplayInfo displayInfo, Context context, int i) {
        if (i == 0) {
            return WindowManagerWrapper.getInstance().hasSoftNavigationBar(context, i);
        }
    ...
    public static int navigationBarPosition(Resources resources, int i, int i2, int i3) {
        if (!(i != i2 && resources.getBoolean(R.bool.config_cecQuerySadLpcmDisabled_allowed)) || i <= i2) {
            return 4;
        }
        return i3 == 1 ? 2 : 1;
    }
    ...
    public static int getNavigationBarSize(Resources resources, int i, boolean z, int i2) {
        if ((i2 & 15) == 3) {
            if (i == 4) {
                return resources.getDimensionPixelSize(z ? R.dimen.indeterminate_progress_alpha_43 : R.dimen.indeterminate_progress_alpha_41);
            }
            return resources.getDimensionPixelSize(R.dimen.indeterminate_progress_alpha_46);
        }
        if (i == 4) {
            return resources.getDimensionPixelSize(z ? R.dimen.indeterminate_progress_alpha_42 : R.dimen.indeterminate_progress_alpha_40);
        }
        return resources.getDimensionPixelSize(R.dimen.indeterminate_progress_alpha_45);
    }

    public static int getNavigationBarFrameHeight(Resources resources, boolean z) {
        return resources.getDimensionPixelSize(z ? R.dimen.indeterminate_progress_alpha_38 : R.dimen.indeterminate_progress_alpha_37);
    }
}
