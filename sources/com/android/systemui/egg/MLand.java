...
public class MLand extends FrameLayout {
    ...
    private static class Params {
        ...
        public Params(Resources resources) throws Resources.NotFoundException {
    ...
    public void reset() throws Resources.NotFoundException {
        ...
        if (z2) {
            ...
            if (this.mTimeOfDay == 0) {
                ...
                star.setTranslationY(frand(this.mHeight * 0.66f, r10 - dimensionPixelSize));
        ...
        for (int i5 = 0; i5 < 20; i5++) {
            ...
            if (dFrand < 0.3d && this.mTimeOfDay != 0) {
                ...
                if (this.mScene == 0) {
                    ...
                    cactus.h = irand(PARAMS.BUILDING_HEIGHT_MIN, i4);
                }
                int i7 = (int) (cactus.z * 255.0f);
                Drawable background = cactus.getBackground();
                if (background != null) {
                    background.setColorFilter(Color.rgb(i7, i7, i7), PorterDuff.Mode.MULTIPLY);
                }
            }
            ...
            if (cactus instanceof Building) {
                ...
                if (cactus instanceof Star) {
                    ...
                    int i8 = this.mHeight;
                    layoutParams.topMargin = ((int) (1.0f - (((fFrand2 * fFrand2) * i8) / 2.0f))) + (i8 / 2);
                }
            }
            addView(cactus, layoutParams);
            int i9 = layoutParams.width;
            cactus.setTranslationX(frand(-i9, this.mWidth + i9));
        }
        Iterator<Player> it = this.mPlayers.iterator();
        while (it.hasNext()) {
            Player next = it.next();
        ...
        timeAnimator2.setTimeListener(new TimeAnimator.TimeListener() { // from class: com.android.systemui.egg.MLand.1
            ...
            public void onTimeUpdate(TimeAnimator timeAnimator3, long j, long j2) throws Resources.NotFoundException {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void step(long j, long j2) throws Resources.NotFoundException {
        float f = j / 1000.0f;
        this.t = f;
        float f2 = j2 / 1000.0f;
        this.dt = f2;
        ...
        if (this.mPlaying) {
            ...
            if (f3 - this.mLastPipeTime > PARAMS.OBSTACLE_PERIOD) {
                ...
                int i7 = ((int) (fFrand * ((i6 - (r6 * 2)) - params.OBSTACLE_GAP))) + params.OBSTACLE_MIN;
                int i8 = params.OBSTACLE_WIDTH;
                int i9 = (i8 - params.OBSTACLE_STEM_WIDTH) / 2;
                int iIrand = irand(0, 250);
                Stem stem = new Stem(getContext(), i7 - r4, false);
                addView(stem, new FrameLayout.LayoutParams(PARAMS.OBSTACLE_STEM_WIDTH, (int) stem.h, 51));
                stem.setTranslationX(this.mWidth + i9);
                float f4 = i8 / 2;
                ...
                addView(pop, new FrameLayout.LayoutParams(i10, i10, 51));
                pop.setTranslationX(this.mWidth);
                pop.setTranslationY(-PARAMS.OBSTACLE_WIDTH);
                pop.setTranslationZ(PARAMS.OBSTACLE_Z);
                pop.setScaleX(0.25f);
                pop.setScaleY(-0.25f);
                pop.animate().translationY(stem.h - i9).scaleX(1.0f).scaleY(-1.0f).setStartDelay(j3).setDuration(250L);
                this.mObstaclesInPlay.add(pop);
                int iIrand2 = irand(0, 250);
                Stem stem2 = new Stem(getContext(), ((this.mHeight - i7) - PARAMS.OBSTACLE_GAP) - r4, true);
                addView(stem2, new FrameLayout.LayoutParams(PARAMS.OBSTACLE_STEM_WIDTH, (int) stem2.h, 51));
                stem2.setTranslationX(this.mWidth + i9);
                stem2.setTranslationY(this.mHeight + r4);
                ...
                addView(pop2, new FrameLayout.LayoutParams(i11, i11, 51));
    ...
    public void onDraw(Canvas canvas) {
        ...
        while (it.hasNext()) {
            ...
            if (next.mTouchX > 0.0f) {
                ...
                canvas.drawLine((float) (f + (Math.cos(dAtan2) * 100.0d)), (float) (f2 + (Math.sin(dAtan2) * 100.0d)), x, y, this.mPlayerTracePaint);
            }
        }
    }
