...
public class SlicePermissionActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
    ...
    protected void onCreate(Bundle bundle) {
        ...
        try {
            ...
            verifyCallingPkg();
            String strUnicodeWrap = BidiFormatter.getInstance().unicodeWrap(packageManager.getApplicationInfo(this.mCallingPkg, 0).loadSafeLabel(packageManager, 500.0f, 5).toString());
            String strUnicodeWrap2 = BidiFormatter.getInstance().unicodeWrap(packageManager.getApplicationInfo(this.mProviderPkg, 0).loadSafeLabel(packageManager, 500.0f, 5).toString());
            ...
            alertDialogCreate.getWindow().addSystemFlags(LineageHardwareManager.FEATURE_TOUCHSCREEN_GESTURES);
