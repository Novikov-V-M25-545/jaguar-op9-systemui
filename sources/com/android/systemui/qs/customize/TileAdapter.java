...
public class TileAdapter extends RecyclerView.Adapter<Holder> implements TileQueryHelper.TileStateListener {
    ...
    public TileAdapter(Context context, UiEventLogger uiEventLogger) {
        ItemTouchHelper.Callback callback = new ItemTouchHelper.Callback() { // from class: com.android.systemui.qs.customize.TileAdapter.7
    ...
    public Holder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 3) {
            return new Holder(layoutInflaterFrom.inflate(R.layout.qs_customize_header, viewGroup, false));
        }
        if (i == 4) {
    ...
    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public void onBindViewHolder(final Holder holder, int i) throws Resources.NotFoundException {
        String string;
                ...
                holder.mTileView.setOnClickListener(new View.OnClickListener() { // from class: com.android.systemui.qs.customize.TileAdapter.2
                    ...
                    public void onClick(View view) {
                        ...
                        if (adapterPosition < TileAdapter.this.mEditIndex) {
                            if (TileAdapter.this.canRemoveTiles()) {
                                TileAdapter tileAdapter = TileAdapter.this;
                                tileAdapter.move(adapterPosition, tileAdapter.mEditIndex, holder.mTileView);
                                return;
                            }
                            return;
                        }
                        TileAdapter tileAdapter2 = TileAdapter.this;
                        tileAdapter2.move(adapterPosition, tileAdapter2.mEditIndex, holder.mTileView);
                    }
                });
            }
            if (this.mAccessibilityManager.isTouchExplorationEnabled()) {
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        public void clearDrag() {
            ...
            CustomizeTileView customizeTileView = this.mTileView;
            int i = R.id.tile_label;
            customizeTileView.findViewById(i).clearAnimation();
            this.mTileView.findViewById(i).setAlpha(1.0f);
