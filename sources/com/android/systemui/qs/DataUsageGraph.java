...
public class DataUsageGraph extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float f = width;
        float f2 = this.mUsageLevel;
        long j2 = this.mMaxLevel;
        float fMin = (f2 / j2) * f;
        if (z) {
            fMin = Math.min(Math.max(((j / j2) * f) - (r5 / 2), this.mMarkerWidth), width - (this.mMarkerWidth * 2));
        ...
        rectF.set(fMin2, 0.0f, this.mMarkerWidth + fMin2, f3);
