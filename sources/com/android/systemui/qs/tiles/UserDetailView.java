    ...
    public static class Adapter extends UserSwitcherController.BaseUserAdapter implements View.OnClickListener {
        ...
        public UserDetailItemView createUserDetailItemView(View view, ViewGroup viewGroup, UserSwitcherController.UserRecord userRecord) {
            ...
            if (!userRecord.isCurrent || userRecord.isGuest) {
                ...
                userDetailItemViewConvertOrInflate.setOnClickListener(null);
                userDetailItemViewConvertOrInflate.setClickable(false);
            }
            String name = getName(this.mContext, userRecord);
            if (userRecord.picture == null) {
                userDetailItemViewConvertOrInflate.bind(name, getDrawable(this.mContext, userRecord).mutate(), userRecord.resolveId());
            } else {
                ...
                userDetailItemViewConvertOrInflate.bind(name, circleFramedDrawable, userRecord.info.id);
            }
            ...
            userDetailItemViewConvertOrInflate.setEnabled(userRecord.isSwitchToEnabled);
            userDetailItemViewConvertOrInflate.setAlpha(userDetailItemViewConvertOrInflate.isEnabled() ? 1.0f : 0.38f);
            if (userRecord.isCurrent) {
                this.mCurrentUserView = userDetailItemViewConvertOrInflate;
            }
