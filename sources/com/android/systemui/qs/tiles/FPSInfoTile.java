...
public class FPSInfoTile extends QSTileImpl<QSTile.BooleanState> {
    ...
    public FPSInfoTile(QSHost qSHost) {
        super(qSHost);
        this.mIcon = QSTileImpl.ResourceIcon.get(R.drawable.ic_qs_fps_info);
        this.mSetting = new SystemSetting(this.mContext, this.mHandler, "show_fps_overlay") { // from class: com.android.systemui.qs.tiles.FPSInfoTile.1
            @Override // com.android.systemui.qs.SystemSetting
            protected void handleValueChanged(int i, boolean z) {
                FPSInfoTile.this.handleRefreshState(Integer.valueOf(i));
            }
        };
    }
    ...
    public void handleUpdateState(QSTile.BooleanState booleanState, Object obj) {
        ...
        int i = R.string.quick_settings_fpsinfo_label;
    ...
    public CharSequence getTileLabel() {
        return this.mContext.getString(R.string.quick_settings_fpsinfo_label);
    }
