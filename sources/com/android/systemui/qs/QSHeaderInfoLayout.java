...
public final class QSHeaderInfoLayout extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById, "findViewById(R.id.alarm_container)");
        this.alarmContainer = viewFindViewById;
        View viewFindViewById2 = findViewById(R.id.ringer_container);
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById2, "findViewById(R.id.ringer_container)");
        this.ringerContainer = viewFindViewById2;
        View viewFindViewById3 = findViewById(R.id.status_separator);
        Intrinsics.checkExpressionValueIsNotNull(viewFindViewById3, "findViewById(R.id.status_separator)");
        this.statusSeparator = viewFindViewById3;
    }
    ...
    protected void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        int iLayoutView = 0 + layoutView(view2, i5, i6, 0, zIsLayoutRtl);
        View view3 = this.statusSeparator;
        if (view3 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("statusSeparator");
        }
        int iLayoutView2 = layoutView(view3, i5, i6, iLayoutView, zIsLayoutRtl) + iLayoutView;
        View view4 = this.ringerContainer;
        if (view4 == null) {
            Intrinsics.throwUninitializedPropertyAccessException("ringerContainer");
        }
        layoutView(view4, i5, i6, iLayoutView2, zIsLayoutRtl);
    }
