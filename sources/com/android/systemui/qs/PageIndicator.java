...
public class PageIndicator extends ViewGroup {
    ...
    public PageIndicator(Context context, AttributeSet attributeSet) {
        ...
        int dimension = (int) ((ViewGroup) this).mContext.getResources().getDimension(R.dimen.qs_page_indicator_width);
        this.mPageIndicatorWidth = dimension;
        this.mPageIndicatorHeight = (int) ((ViewGroup) this).mContext.getResources().getDimension(R.dimen.qs_page_indicator_height);
