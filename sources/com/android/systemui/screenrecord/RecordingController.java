...
public class RecordingController implements CallbackController<RecordingStateChangeCallback> {
    ...
    public void startCountdown(long j, long j2, final PendingIntent pendingIntent, PendingIntent pendingIntent2) {
        ...
        CountDownTimer countDownTimer = new CountDownTimer(j, j2) { // from class: com.android.systemui.screenrecord.RecordingController.2
            ...
            @Override // android.os.CountDownTimer
            public void onFinish() throws PendingIntent.CanceledException {
    ...
    public void stopRecording() throws PendingIntent.CanceledException {
        try {
