...
public class WorkLockActivity extends Activity {
    ...
    private void showConfirmCredentialActivity() {
        ...
        if (isFinishing() || !getKeyguardManager().isDeviceLocked(getTargetUserId()) || (intentCreateConfirmDeviceCredentialIntent = getKeyguardManager().createConfirmDeviceCredentialIntent(null, null, getTargetUserId(), true)) == null) {
            return;
        }
