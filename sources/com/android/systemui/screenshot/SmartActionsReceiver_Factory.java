...
public final class SmartActionsReceiver_Factory implements Factory<SmartActionsReceiver> {
    ...
    public SmartActionsReceiver get() {
        return provideInstance(this.screenshotSmartActionsProvider);
    }

    public static SmartActionsReceiver provideInstance(Provider<ScreenshotSmartActions> provider) {
        return new SmartActionsReceiver(provider.get());
    }
