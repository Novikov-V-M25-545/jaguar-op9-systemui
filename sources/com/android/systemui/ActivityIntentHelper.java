...
public class ActivityIntentHelper {
    ...
    public ActivityInfo getTargetActivityInfo(Intent intent, int i, boolean z) {
        ...
        if (listQueryIntentActivitiesAsUser.size() == 0 || (resolveInfoResolveActivityAsUser = packageManager.resolveActivityAsUser(intent, i2 | 128, i)) == null || wouldLaunchResolverActivity(resolveInfoResolveActivityAsUser, (List<ResolveInfo>) listQueryIntentActivitiesAsUser)) {
            return null;
        }
