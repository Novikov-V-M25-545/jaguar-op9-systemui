...
public final class WidgetState {
    ...
    public int hashCode() {
        int iHashCode = ((((((((((((((Float.hashCode(this.x) * 31) + Float.hashCode(this.y)) * 31) + Integer.hashCode(this.width)) * 31) + Integer.hashCode(this.height)) * 31) + Integer.hashCode(this.measureWidth)) * 31) + Integer.hashCode(this.measureHeight)) * 31) + Float.hashCode(this.alpha)) * 31) + Float.hashCode(this.scale)) * 31;
        boolean z = this.gone;
        int i = z;
        if (z != 0) {
            i = 1;
    ...
    public /* synthetic */ WidgetState(float f, float f2, int i, int i2, int i3, int i4, float f3, float f4, boolean z, int i5, DefaultConstructorMarker defaultConstructorMarker) {
        this((i5 & 1) != 0 ? 0.0f : f, (i5 & 2) != 0 ? 0.0f : f2, (i5 & 4) != 0 ? 0 : i, (i5 & 8) != 0 ? 0 : i2, (i5 & 16) != 0 ? 0 : i3, (i5 & 32) != 0 ? 0 : i4, (i5 & 64) != 0 ? 1.0f : f3, (i5 & 128) != 0 ? 1.0f : f4, (i5 & LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT) != 0 ? false : z);
    }
    ...
    public final void initFromLayout(@NotNull View view) {
        ...
        if (z) {
            ...
            Intrinsics.checkExpressionValueIsNotNull(layoutParams2.getConstraintWidget(), "layoutParams.constraintWidget");
            this.x = r0.getLeft();
            Intrinsics.checkExpressionValueIsNotNull(layoutParams2.getConstraintWidget(), "layoutParams.constraintWidget");
            this.y = r0.getTop();
            ...
            this.width = constraintWidget.getWidth();
