...
class ThresholdSensorImpl implements ThresholdSensor {
    ...
    public String toString() {
        return String.format("{registered=%s, paused=%s, threshold=%s, sensor=%s}", Boolean.valueOf(isLoaded()), Boolean.valueOf(this.mRegistered), Boolean.valueOf(this.mPaused), Float.valueOf(this.mThreshold), this.mSensor);
    }
    ...
    static class Builder {
        ...
        Builder setSensorDelay(int i) {
            this.mSensorDelay = i;
            return this;
        }

        Builder setSensorResourceId(int i) {
            setSensorType(this.mResources.getString(i));
            return this;
        }

        Builder setThresholdResourceId(int i) {
            try {
        ...
        Builder setThresholdLatchResourceId(int i) {
            try {
        ...
        Builder setSensorType(String str) {
            Sensor sensorFindSensorByType = findSensorByType(str);
        ...
        Builder setThresholdValue(float f) {
        ...
        private Sensor findSensorByType(String str) {
            if (str.isEmpty()) {
                return null;
            }
