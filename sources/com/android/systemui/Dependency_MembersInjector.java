...
public final class Dependency_MembersInjector {
    ...
    public static void injectMAssistManager(Dependency dependency, Lazy<AssistManagerGoogle> lazy) {
    ...
    public static void injectMScreenDecorations(Dependency dependency, Lazy<ScreenDecorations> lazy) {
        dependency.mScreenDecorations = lazy;
    }
}
