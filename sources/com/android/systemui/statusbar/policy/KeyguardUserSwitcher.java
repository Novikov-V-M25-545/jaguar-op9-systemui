...
public class KeyguardUserSwitcher {
    ...
    public KeyguardUserSwitcher(Context context, ViewStub viewStub, KeyguardStatusBarView keyguardStatusBarView, NotificationPanelViewController notificationPanelViewController) {
        DataSetObserver dataSetObserver = new DataSetObserver() { // from class: com.android.systemui.statusbar.policy.KeyguardUserSwitcher.4
        ...
        boolean z = context.getResources().getBoolean(R.bool.config_cecQuerySadDstEnabled_allowed);
        ...
        if (userSwitcherController != null && z) {
            Container container = (Container) viewStub.inflate();
            this.mUserSwitcherContainer = container;
            ...
            container.setKeyguardUserSwitcher(this);
            return;
        }
    ...
    private void reinflateViews() {
        ...
        LayoutInflater.from(this.mUserSwitcherContainer.getContext()).inflate(com.android.systemui.R.layout.keyguard_user_switcher_inner, this.mUserSwitcherContainer);
        ViewGroup viewGroup2 = (ViewGroup) this.mUserSwitcherContainer.findViewById(com.android.systemui.R.id.keyguard_user_switcher_inner);
    ...
    private void startAppearAnimation() {
        ...
        ObjectAnimator objectAnimatorOfInt = ObjectAnimator.ofInt(this.mBackground, "alpha", 0, 255);
        this.mBgAnimator = objectAnimatorOfInt;
    ...
    public static class Adapter extends UserSwitcherController.BaseUserAdapter implements View.OnClickListener {
        ...
        public View getView(int i, View view, ViewGroup viewGroup) {
            ...
            if (!(view instanceof UserDetailItemView) || !(view.getTag() instanceof UserSwitcherController.UserRecord)) {
                view = LayoutInflater.from(this.mContext).inflate(com.android.systemui.R.layout.keyguard_user_switcher_item, viewGroup, false);
            ...
            if (item.picture == null) {
                ...
                CircleFramedDrawable circleFramedDrawable = new CircleFramedDrawable(item.picture, (int) this.mContext.getResources().getDimension(com.android.systemui.R.dimen.kg_framed_avatar_size));
        ...
        private static Drawable getDrawable(Context context, UserSwitcherController.UserRecord userRecord) {
            ...
            if (userRecord.isCurrent) {
                i = com.android.systemui.R.color.kg_user_switcher_selected_avatar_icon_color;
            } else if (!userRecord.isSwitchToEnabled) {
                i = com.android.systemui.R.color.GM2_grey_600;
            } else {
                i = com.android.systemui.R.color.kg_user_switcher_avatar_icon_color;
            }
            iconDrawable.setTint(context.getResources().getColor(i, context.getTheme()));
            return userRecord.isCurrent ? new LayerDrawable(new Drawable[]{context.getDrawable(com.android.systemui.R.drawable.bg_avatar_selected), iconDrawable}) : iconDrawable;
        }
