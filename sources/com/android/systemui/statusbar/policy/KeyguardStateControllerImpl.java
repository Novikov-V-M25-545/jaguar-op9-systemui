...
public class KeyguardStateControllerImpl implements KeyguardStateController, Dumpable {
    ...
    public synchronized void addCallback(KeyguardStateController.Callback callback) {
    ...
    @Override // com.android.systemui.statusbar.policy.CallbackController
    public synchronized void removeCallback(KeyguardStateController.Callback callback) {
        Objects.requireNonNull(callback, "Callback must not be null. b/128895449");
    ...
    public void notifyKeyguardChanged() {
        ...
        new ArrayList(this.mCallbacks).forEach(new Consumer() { // from class: com.android.systemui.statusbar.policy.KeyguardStateControllerImpl$$ExternalSyntheticLambda0
    ...
    private void notifyUnlockedChanged() {
        ...
        new ArrayList(this.mCallbacks).forEach(new Consumer() { // from class: com.android.systemui.statusbar.policy.KeyguardStateControllerImpl$$ExternalSyntheticLambda1
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
    ...
    void update(boolean z) {
        ...
        if (!zIsSecure || this.mKeyguardUpdateMonitor.getUserCanSkipBouncer(currentUser)) {
            z2 = true;
        } else {
        ...
        boolean zIsFaceAuthEnabledForUser = this.mKeyguardUpdateMonitor.isFaceAuthEnabledForUser(currentUser);
        if (((zIsSecure == this.mSecure && z2 == this.mCanDismissLockScreen && userTrustIsManaged == this.mTrustManaged && this.mTrusted == userHasTrust && this.mFaceAuthEnabled == zIsFaceAuthEnabledForUser) ? false : true) || z) {
            this.mSecure = zIsSecure;
            this.mCanDismissLockScreen = z2;
            this.mTrusted = userHasTrust;
            this.mTrustManaged = userTrustIsManaged;
            this.mFaceAuthEnabled = zIsFaceAuthEnabledForUser;
