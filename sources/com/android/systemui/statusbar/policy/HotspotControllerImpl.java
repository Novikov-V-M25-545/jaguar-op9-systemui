    ...
    public void setHotspotEnabled(boolean z) {
        if (this.mWaitingForTerminalState) {
            ...
            if (z) {
                ...
                this.mTetheringManager.startTethering(new TetheringManager.TetheringRequest.Builder(0).build(), ConcurrentUtils.DIRECT_EXECUTOR, new TetheringManager.StartTetheringCallback() { // from class: com.android.systemui.statusbar.policy.HotspotControllerImpl.2
