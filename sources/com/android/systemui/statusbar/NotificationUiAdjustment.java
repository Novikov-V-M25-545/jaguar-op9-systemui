...
public class NotificationUiAdjustment {
    ...
    public static boolean needReinflate(NotificationUiAdjustment notificationUiAdjustment, NotificationUiAdjustment notificationUiAdjustment2) {
        ...
        return (notificationUiAdjustment.isConversation == notificationUiAdjustment2.isConversation && !areDifferent(notificationUiAdjustment.smartActions, notificationUiAdjustment2.smartActions) && notificationUiAdjustment2.smartReplies.equals(notificationUiAdjustment.smartReplies)) ? false : true;
    }
