...
public class SuperStatusBarViewFactory {
    ...
    public NotificationShadeWindowView getNotificationShadeWindowView() {
        ...
        LockIcon lockIcon = (LockIcon) notificationShadeWindowView2.findViewById(R.id.lock_icon);
        if (lockIcon != null) {
    ...
    public NotificationShelf getNotificationShelf(ViewGroup viewGroup) {
        ...
        NotificationShelf notificationShelf2 = (NotificationShelf) this.mInjectionInflationController.injectable(LayoutInflater.from(this.mContext)).inflate(R.layout.status_bar_notification_shelf, viewGroup, false);
