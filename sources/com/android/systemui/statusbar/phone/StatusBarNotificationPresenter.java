...
public class StatusBarNotificationPresenter implements NotificationPresenter, ConfigurationController.ConfigurationListener, NotificationRowBinderImpl.BindRowCallback, CommandQueue.Callbacks {
    ...
    public StatusBarNotificationPresenter(Context context, NotificationPanelViewController notificationPanelViewController, HeadsUpManagerPhone headsUpManagerPhone, NotificationShadeWindowView notificationShadeWindowView, ViewGroup viewGroup, DozeScrimController dozeScrimController, ScrimController scrimController, ActivityLaunchAnimator activityLaunchAnimator, DynamicPrivacyController dynamicPrivacyController, KeyguardStateController keyguardStateController, KeyguardIndicationController keyguardIndicationController, StatusBar statusBar, ShadeController shadeController, CommandQueue commandQueue, InitController initController, final NotificationInterruptStateProvider notificationInterruptStateProvider) {
        ...
        this.mCheckSaveListener = new NotificationInfo.CheckSaveListener() { // from class: com.android.systemui.statusbar.phone.StatusBarNotificationPresenter.3
        };
        this.mOnSettingsClickListener = new NotificationGutsManager.OnSettingsClickListener() { // from class: com.android.systemui.statusbar.phone.StatusBarNotificationPresenter.4
        ...
        this.mInterruptSuppressor = new NotificationInterruptSuppressor() { // from class: com.android.systemui.statusbar.phone.StatusBarNotificationPresenter.5
            ...
            public boolean suppressAwakeHeadsUp(NotificationEntry notificationEntry) {
                ...
                if (StatusBarNotificationPresenter.this.mStatusBar.isOccluded()) {
                    ...
                    boolean zNeedsRedaction = StatusBarNotificationPresenter.this.mLockscreenUserManager.needsRedaction(notificationEntry);
        ...
        if (iVrManagerAsInterface != null) {
            try {
                iVrManagerAsInterface.registerListener(stub);
        ...
        initController.addPostInitTask(new Runnable() { // from class: com.android.systemui.statusbar.phone.StatusBarNotificationPresenter$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.lambda$new$0(notificationListContainer, notificationRemoteInputManager, notificationInterruptStateProvider);
            }
        });
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public /* synthetic */ void lambda$new$0(NotificationListContainer notificationListContainer, NotificationRemoteInputManager notificationRemoteInputManager, NotificationInterruptStateProvider notificationInterruptStateProvider) {
    ...
    @Override // com.android.systemui.statusbar.NotificationPresenter
    /* renamed from: updateNotificationViews, reason: merged with bridge method [inline-methods] */
    public void lambda$updateNotificationViews$1(final String str) {
        ...
        if (isCollapsing()) {
            this.mShadeController.addPostCollapseAction(new Runnable() { // from class: com.android.systemui.statusbar.phone.StatusBarNotificationPresenter$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.lambda$updateNotificationViews$1(str);
                }
            });
        } else {
    ...
    public void onNotificationRemoved(String str, StatusBarNotification statusBarNotification) {
        ...
        if (this.mStatusBarStateController.getState() == 0) {
            ...
            if (this.mStatusBarStateController.getState() != 2 || isCollapsing()) {
                return;
            }
    ...
    public void onBindRow(ExpandableNotificationRow expandableNotificationRow) {
        ...
        expandableNotificationRow.setSecureStateProvider(new BooleanSupplier() { // from class: com.android.systemui.statusbar.phone.StatusBarNotificationPresenter$$ExternalSyntheticLambda3
            ...
            public final boolean getAsBoolean() {
                return keyguardStateController.canDismissLockScreen();
            }
        });
    }
    ...
    @Override // com.android.systemui.statusbar.notification.row.ActivatableNotificationView.OnActivatedListener
    public void onActivationReset(ActivatableNotificationView activatableNotificationView) throws Resources.NotFoundException {
    ...
    public int getMaxNotificationsWhileLocked(boolean z) {
        if (z) {
            int iMax = Math.max(1, this.mNotificationPanel.computeMaxKeyguardNotifications(this.mMaxAllowedKeyguardNotifications));
            this.mMaxKeyguardNotifications = iMax;
            return iMax;
        }
