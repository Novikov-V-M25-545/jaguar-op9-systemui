...
public class KeyguardAffordanceHelper {
    ...
    private void setTranslation(float f, boolean z, boolean z2) {
        float fMax = rightSwipePossible() ? f : Math.max(0.0f, f);
        ...
        if (f2 != this.mTranslation || z) {
            ...
            updateIcon(keyguardAffordanceView2, 0.0f, fMax2 * keyguardAffordanceView2.getRestingAlpha(), z3, z5, z, z4);
    ...
    public void updateIconsFromTranslation(KeyguardAffordanceView keyguardAffordanceView) {
        ...
        updateIconAlpha(keyguardAffordanceView2, fMax * keyguardAffordanceView2.getRestingAlpha(), false);
    }
    ...
    private float getCurrentVelocity(float f, float f2) {
        ...
        return this.mTargetedView == this.mRightIcon ? -fHypot : fHypot;
    }
