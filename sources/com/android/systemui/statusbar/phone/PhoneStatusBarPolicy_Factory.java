...
public final class PhoneStatusBarPolicy_Factory implements Factory<PhoneStatusBarPolicy> {
    ...
    public PhoneStatusBarPolicy_Factory(Provider<Context> provider, Provider<StatusBarIconController> provider2, Provider<CommandQueue> provider3, Provider<BroadcastDispatcher> provider4, Provider<Executor> provider5, Provider<Resources> provider6, Provider<CastController> provider7, Provider<HotspotController> provider8, Provider<BluetoothController> provider9, Provider<NextAlarmController> provider10, Provider<UserInfoController> provider11, Provider<RotationLockController> provider12, Provider<DataSaverController> provider13, Provider<ZenModeController> provider14, Provider<DeviceProvisionedController> provider15, Provider<KeyguardStateController> provider16, Provider<LocationController> provider17, Provider<SensorPrivacyController> provider18, Provider<IActivityManager> provider19, Provider<AlarmManager> provider20, Provider<UserManager> provider21, Provider<RecordingController> provider22, Provider<TelecomManager> provider23, Provider<Integer> provider24, Provider<SharedPreferences> provider25, Provider<DateFormatUtil> provider26, Provider<RingerModeTracker> provider27, Provider<PrivacyItemController> provider28) {
