...
public class NotificationShadeWindowView extends FrameLayout {
    ...
    public NotificationShadeWindowView(Context context, AttributeSet attributeSet) {
        ...
        this.mRightInset = 0;
        this.mLeftInset = 0;
        this.mFakeWindow = new Window(((FrameLayout) this).mContext) { // from class: com.android.systemui.statusbar.phone.NotificationShadeWindowView.2
    ...
    protected void setInteractionEventHandler(InteractionEventHandler interactionEventHandler) {
        this.mInteractionEventHandler = interactionEventHandler;
    }

    @Override // android.view.ViewGroup, android.view.View
    public boolean dispatchTouchEvent(MotionEvent motionEvent) {
        Boolean boolHandleDispatchTouchEvent = this.mInteractionEventHandler.handleDispatchTouchEvent(motionEvent);
        return boolHandleDispatchTouchEvent != null ? boolHandleDispatchTouchEvent.booleanValue() : super.dispatchTouchEvent(motionEvent);
    }

    @Override // android.view.ViewGroup
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        boolean zShouldInterceptTouchEvent = this.mInteractionEventHandler.shouldInterceptTouchEvent(motionEvent);
        if (!zShouldInterceptTouchEvent) {
            zShouldInterceptTouchEvent = super.onInterceptTouchEvent(motionEvent);
        }
        if (zShouldInterceptTouchEvent) {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        boolean zHandleTouchEvent = this.mInteractionEventHandler.handleTouchEvent(motionEvent);
        if (!zHandleTouchEvent) {
            zHandleTouchEvent = super.onTouchEvent(motionEvent);
        }
        if (!zHandleTouchEvent) {
    ...
    class LayoutParams extends FrameLayout.LayoutParams {
        ...
        LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.ignoreRightInset = typedArrayObtainStyledAttributes.getBoolean(R.styleable.StatusBarWindowView_Layout_ignoreRightInset, false);
