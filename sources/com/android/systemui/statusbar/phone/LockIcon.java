...
public class LockIcon extends KeyguardAffordanceView {
    ...
    void update(int i, boolean z, boolean z2, boolean z3) {
    ...
    private static int getIconForState(int i) {
        if (i != 0) {
            if (i == 1) {
                return android.R.drawable.ic_corp_badge;
            }
            if (i != 2 && i != 3) {
                throw new IllegalArgumentException();
            }
        }
        return android.R.drawable.ic_commit_search_api_material;
    }

    private int getThemedAnimationResId(int i) {
        String strEmptyIfNull = TextUtils.emptyIfNull(Settings.Secure.getString(getContext().getContentResolver(), "theme_customization_overlay_packages"));
        if (strEmptyIfNull.contains("com.android.theme.icon_pack.circular.android")) {
            return LOCK_ANIM_RES_IDS[1][i];
        }
        if (strEmptyIfNull.contains("com.android.theme.icon_pack.filled.android")) {
            return LOCK_ANIM_RES_IDS[2][i];
        }
        if (strEmptyIfNull.contains("com.android.theme.icon_pack.rounded.android")) {
