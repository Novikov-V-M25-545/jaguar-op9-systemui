...
public final class TouchAnalyticsProto$Session extends MessageNano {
    ...
    public static final class TouchEvent extends MessageNano {
        ...
        public static final class Pointer extends MessageNano {
            ...
            protected int computeSerializedSize() {
                ...
                if (Float.floatToIntBits(this.x) != Float.floatToIntBits(0.0f)) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeFloatSize(1, this.x);
                }
                if (Float.floatToIntBits(this.y) != Float.floatToIntBits(0.0f)) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeFloatSize(2, this.y);
                }
                if (Float.floatToIntBits(this.size) != Float.floatToIntBits(0.0f)) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeFloatSize(3, this.size);
                }
                if (Float.floatToIntBits(this.pressure) != Float.floatToIntBits(0.0f)) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeFloatSize(4, this.pressure);
                }
                int i = this.id;
                if (i != 0) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeInt32Size(5, i);
                }
                return Float.floatToIntBits(this.removedLength) != Float.floatToIntBits(0.0f) ? iComputeSerializedSize + CodedOutputByteBufferNano.computeFloatSize(6, this.removedLength) : iComputeSerializedSize;
            }
        }
    ...
    public static final class SensorEvent extends MessageNano {
        ...
        protected int computeSerializedSize() {
            ...
            float[] fArr = this.values;
            if (fArr != null && fArr.length > 0) {
                iComputeSerializedSize = iComputeSerializedSize + (fArr.length * 4) + (fArr.length * 1);
            }
            long j2 = this.timestamp;
    ...
    protected int computeSerializedSize() {
        ...
        if (!this.build.equals("")) {
            iComputeSerializedSize += CodedOutputByteBufferNano.computeStringSize(3, this.build);
        }
        int i = this.result;
        if (i != 0) {
        ...
        if (touchEventArr != null && touchEventArr.length > 0) {
            ...
            while (true) {
                ...
                TouchEvent touchEvent = touchEventArr2[i3];
                if (touchEvent != null) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(5, touchEvent);
                }
                i3++;
            }
        }
        ...
        if (sensorEventArr != null && sensorEventArr.length > 0) {
            ...
            while (true) {
                ...
                SensorEvent sensorEvent = sensorEventArr2[i4];
                if (sensorEvent != null) {
                    iComputeSerializedSize += CodedOutputByteBufferNano.computeMessageSize(6, sensorEvent);
                }
                i4++;
            }
        }
        int i5 = this.touchAreaWidth;
        if (i5 != 0) {
            iComputeSerializedSize += CodedOutputByteBufferNano.computeInt32Size(9, i5);
        }
        int i6 = this.touchAreaHeight;
        if (i6 != 0) {
        ...
        int i7 = this.type;
        if (i7 != 0) {
            iComputeSerializedSize += CodedOutputByteBufferNano.computeInt32Size(11, i7);
        }
        PhoneEvent[] phoneEventArr = this.phoneEvents;
        if (phoneEventArr != null && phoneEventArr.length > 0) {
            while (true) {
        ...
        return !this.deviceId.equals("") ? iComputeSerializedSize + CodedOutputByteBufferNano.computeStringSize(13, this.deviceId) : iComputeSerializedSize;
    }
}
