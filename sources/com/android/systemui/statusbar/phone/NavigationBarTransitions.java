...
public final class NavigationBarTransitions extends BarTransitions implements LightBarTransitionsController.DarkIntensityApplier {
    ...
    class AnonymousClass1 extends IWallpaperVisibilityListener.Stub {
        ...
        public void onWallpaperVisibilityChanged(boolean z, int i) throws RemoteException {
            ...
            NavigationBarTransitions.this.mHandler.post(new Runnable() { // from class: com.android.systemui.statusbar.phone.NavigationBarTransitions$1$$ExternalSyntheticLambda0
    ...
    public NavigationBarTransitions(NavigationBarView navigationBarView, CommandQueue commandQueue) {
        ...
        this.mView.addOnLayoutChangeListener(new View.OnLayoutChangeListener() { // from class: com.android.systemui.statusbar.phone.NavigationBarTransitions$$ExternalSyntheticLambda0
    ...
    void setBackgroundFrame(Rect rect) {
