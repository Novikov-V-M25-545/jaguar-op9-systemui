...
public class ButtonDispatcher {
    ...
    private final ValueAnimator.AnimatorUpdateListener mAlphaListener = new ValueAnimator.AnimatorUpdateListener() { // from class: com.android.systemui.statusbar.phone.ButtonDispatcher$$ExternalSyntheticLambda0
    ...
    public void setAlpha(float f, boolean z, long j, boolean z2) {
        ...
        if (z) {
            ...
            valueAnimatorOfFloat.setStartDelay(this.mAssistManager.getAssistHandleShowAndGoRemainingDurationMs());
