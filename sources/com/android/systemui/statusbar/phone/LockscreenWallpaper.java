...
public class LockscreenWallpaper extends IWallpaperManagerCallback.Stub implements Runnable, Dumpable {
    ...
    public void dump(FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
        ...
        IndentingPrintWriter indentingPrintWriterIncreaseIndent = new IndentingPrintWriter(printWriter, "  ").increaseIndent();
        indentingPrintWriterIncreaseIndent.println("mCached=" + this.mCached);
        indentingPrintWriterIncreaseIndent.println("mCache=" + this.mCache);
        indentingPrintWriterIncreaseIndent.println("mCurrentUserId=" + this.mCurrentUserId);
        indentingPrintWriterIncreaseIndent.println("mSelectedUser=" + this.mSelectedUser);
    }
    ...
    public static class WallpaperDrawable extends DrawableWrapper {
        ...
        protected void onBoundsChange(Rect rect) {
            ...
            float f4 = height * f3;
            float f5 = (iHeight - f4) * 0.5f;
            this.mTmpRect.set(rect.left, rect.top + Math.round(f5), rect.left + Math.round(width * f3), rect.top + Math.round(f4 + f5));
