...
public enum ScrimState {
    ...
    BOUNCER { // from class: com.android.systemui.statusbar.phone.ScrimState.3
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public void prepare(ScrimState scrimState) {
    ...
    BOUNCER_SCRIMMED { // from class: com.android.systemui.statusbar.phone.ScrimState.4
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public void prepare(ScrimState scrimState) {
    ...
    BRIGHTNESS_MIRROR { // from class: com.android.systemui.statusbar.phone.ScrimState.5
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public void prepare(ScrimState scrimState) {
            this.mBehindAlpha = 0.0f;
            this.mFrontAlpha = 0.0f;
    ...
    AOD { // from class: com.android.systemui.statusbar.phone.ScrimState.6
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public boolean isLowPowerState() {
            return true;
        }
        ...
        public void prepare(ScrimState scrimState) {
            ...
            boolean zIsDocked = this.mDockManager.isDocked();
            this.mBlankScreen = this.mDisplayRequiresBlanking;
            this.mFrontTint = -16777216;
            this.mFrontAlpha = (alwaysOn || zIsDocked) ? this.mAodFrontScrimAlpha : 1.0f;
            this.mBehindTint = -16777216;
            this.mBehindAlpha = 0.0f;
            this.mBubbleTint = 0;
            this.mBubbleAlpha = 0.0f;
    ...
    PULSING { // from class: com.android.systemui.statusbar.phone.ScrimState.7
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public void prepare(ScrimState scrimState) {
            ...
            this.mFrontTint = -16777216;
            this.mBlankScreen = this.mDisplayRequiresBlanking;
            boolean z = this.mWakeLockScreenSensorActive;
            this.mAnimationDuration = z ? 1000L : 220L;
            if (z && scrimState == ScrimState.AOD) {
    ...
    UNLOCKED { // from class: com.android.systemui.statusbar.phone.ScrimState.8
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public void prepare(ScrimState scrimState) {
            this.mBehindAlpha = 0.0f;
            this.mFrontAlpha = 0.0f;
            this.mBubbleAlpha = 0.0f;
            this.mAnimationDuration = this.mKeyguardFadingAway ? this.mKeyguardFadingAwayDuration : 10L;
            this.mAnimateChange = false;
            this.mFrontTint = 0;
            this.mBehindTint = 0;
            this.mBubbleTint = 0;
    ...
    BUBBLE_EXPANDED { // from class: com.android.systemui.statusbar.phone.ScrimState.9
        @Override // com.android.systemui.statusbar.phone.ScrimState
        public void prepare(ScrimState scrimState) {
            this.mFrontTint = 0;
            this.mBehindTint = 0;
