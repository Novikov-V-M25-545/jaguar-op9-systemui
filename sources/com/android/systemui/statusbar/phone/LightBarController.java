...
public class LightBarController implements BatteryController.BatteryStateChangeCallback, Dumpable, ConfigurationController.ConfigurationListener, TunerService.Tunable {
    ...
    public void onTuningChanged(String str, String str2) {
        ...
        if (str.equals("system:display_cutout_mode")) {
            this.mForceDarkIcons = TunerService.parseInteger(str2, 0) == 1;
            updateStatus();
        }
    }
    ...
    void onStatusBarAppearanceChanged(AppearanceRegion[] appearanceRegionArr, boolean z, int i, boolean z2) {
    ...
    void onStatusBarModeChanged(int i) {
        this.mStatusBarMode = i;
        updateStatus();
    }

    void onNavigationBarAppearanceChanged(int i, boolean z, int i2, boolean z2) {
        if (((this.mAppearance ^ i) & 16) != 0 || z) {
            boolean z3 = this.mNavigationLight;
            boolean zIsLight = isLight(i, i2, 16);
            this.mHasLightNavigationBar = zIsLight;
            boolean z4 = zIsLight && ((this.mDirectReplying && this.mNavbarColorManagedByIme) || !this.mForceDarkForScrim) && !this.mQsCustomizing;
    ...
    void onNavigationBarModeChanged(int i) {
    ...
    private void updateStatus() {
        ...
        boolean z = !this.mForceDarkIcons || this.mLandscape;
        int i = -1;
        int i2 = 0;
        ...
        if (i2 == length) {
            ...
            this.mStatusBarIconController.getTransitionsController().setIconsDark(z, animateChange());
        } else if (i2 == 0) {
