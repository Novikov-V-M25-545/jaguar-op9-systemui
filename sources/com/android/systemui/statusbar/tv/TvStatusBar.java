...
public class TvStatusBar extends SystemUI implements CommandQueue.Callbacks {
    ...
    public void start() {
        ...
        try {
            iStatusBarServiceAsInterface.registerStatusBar(this.mCommandQueue);
    ...
    private void startSystemActivity(Intent intent) {
        ...
        ResolveInfo resolveInfoResolveActivity = this.mContext.getPackageManager().resolveActivity(intent, 1048576);
