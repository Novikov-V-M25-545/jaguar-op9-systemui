...
public class StatusBarStateControllerImpl implements SysuiStatusBarStateController, CallbackController<StatusBarStateController.StateListener>, Dumpable {
    ...
    private static final Comparator<SysuiStatusBarStateController.RankedListener> sComparator = Comparator.comparingInt(new ToIntFunction() { // from class: com.android.systemui.statusbar.StatusBarStateControllerImpl$$ExternalSyntheticLambda1
    ...
    private void startDozeAnimation() {
        ...
        this.mDarkAnimator = objectAnimatorOfFloat;
        ...
        synchronized (this.mListeners) {
            this.mListeners.removeIf(new Predicate() { // from class: com.android.systemui.statusbar.StatusBarStateControllerImpl$$ExternalSyntheticLambda0
                ...
                public final boolean test(Object obj) {
                    return StatusBarStateControllerImpl.lambda$removeCallback$1(stateListener, (SysuiStatusBarStateController.RankedListener) obj);
                }
            });
        }
    }
