...
public class ViewState implements Dumpable {
    ...
    public void applyToView(View view) {
        ...
        if (isAnimating(view, TAG_ANIMATOR_ALPHA)) {
            ...
            float f6 = this.alpha;
            if (alpha != f6) {
                boolean z2 = (z || ((f6 > 1.0f ? 1 : (f6 == 1.0f ? 0 : -1)) == 0) || !view.hasOverlappingRendering()) ? false : true;
    ...
    private void startAlphaAnimation(final View view, AnimationProperties animationProperties) {
        ...
        if (f2 == null || f2.floatValue() != f3) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.notification.stack.ViewState.4
    ...
    private void startZTranslationAnimation(final View view, AnimationProperties animationProperties) {
        ...
        if (f2 == null || f2.floatValue() != f3) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.notification.stack.ViewState.5
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
    ...
    private void startXTranslationAnimation(final View view, AnimationProperties animationProperties) {
        ...
        if (f2 == null || f2.floatValue() != f3) {
            ...
            objectAnimatorOfFloat.addListener(new AnimatorListenerAdapter() { // from class: com.android.systemui.statusbar.notification.stack.ViewState.6
                @Override // android.animation.AnimatorListenerAdapter, android.animation.Animator.AnimatorListener
                public void onAnimationEnd(Animator animator) {
