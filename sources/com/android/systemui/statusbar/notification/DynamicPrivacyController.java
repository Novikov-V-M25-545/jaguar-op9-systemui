...
public class DynamicPrivacyController implements KeyguardStateController.Callback {
    ...
    public boolean isInLockedDownShade() {
        int state;
        return this.mStatusBarKeyguardViewManager.isShowing() && this.mKeyguardStateController.isMethodSecure() && ((state = this.mStateController.getState()) == 0 || state == 2) && isDynamicPrivacyEnabled() && !isDynamicallyUnlocked();
    }
