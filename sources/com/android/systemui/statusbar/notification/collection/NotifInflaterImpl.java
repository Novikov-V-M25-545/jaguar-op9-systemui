...
public class NotifInflaterImpl implements NotifInflater {
    ...
    public void rebindViews(NotificationEntry notificationEntry, NotifInflater.InflationCallback inflationCallback) throws InterruptedException {
        inflateViews(notificationEntry, inflationCallback);
    }

    @Override // com.android.systemui.statusbar.notification.collection.inflation.NotifInflater
    public void inflateViews(NotificationEntry notificationEntry, NotifInflater.InflationCallback inflationCallback) throws InterruptedException {
        try {
