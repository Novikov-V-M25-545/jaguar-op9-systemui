...
public class PreparationCoordinator implements Coordinator {
    ...
    PreparationCoordinator(PreparationCoordinatorLogger preparationCoordinatorLogger, NotifInflaterImpl notifInflaterImpl, NotifInflationErrorManager notifInflationErrorManager, NotifViewBarn notifViewBarn, IStatusBarService iStatusBarService, int i) {
        ...
        NotifInflationErrorManager.NotifInflationErrorListener notifInflationErrorListener = new NotifInflationErrorManager.NotifInflationErrorListener() { // from class: com.android.systemui.statusbar.notification.collection.coordinator.PreparationCoordinator.4
        ...
        this.mInflationErrorListener = notifInflationErrorListener;
        ...
        notifInflationErrorManager.addInflationErrorListener(notifInflationErrorListener);
