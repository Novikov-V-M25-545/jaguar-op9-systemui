...
public final class ListAttachState {
    ...
    public int hashCode() {
        ...
        int iHashCode = (groupEntry != null ? groupEntry.hashCode() : 0) * 31;
        NotifSection notifSection = this.section;
        int iHashCode2 = (((iHashCode + (notifSection != null ? notifSection.hashCode() : 0)) * 31) + Integer.hashCode(this.sectionIndex)) * 31;
        NotifFilter notifFilter = this.excludingFilter;
        int iHashCode3 = (iHashCode2 + (notifFilter != null ? notifFilter.hashCode() : 0)) * 31;
        NotifPromoter notifPromoter = this.promoter;
        return iHashCode3 + (notifPromoter != null ? notifPromoter.hashCode() : 0);
    }
