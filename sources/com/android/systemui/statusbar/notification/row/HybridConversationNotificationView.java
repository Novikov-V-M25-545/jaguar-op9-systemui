...
public class HybridConversationNotificationView extends HybridNotificationView {
    ...
    protected void onFinishInflate() {
        ...
        this.mConversationIconView = (ImageView) requireViewById(R.id.clamp);
        this.mConversationFacePile = requireViewById(R.id.chooser_edit_button);
    ...
    public void bind(CharSequence charSequence, CharSequence charSequence2, View view) {
        ...
        if (conversationIcon != null) {
            ...
            View viewRequireViewById = requireViewById(R.id.chooser_edit_button);
            this.mConversationFacePile = viewRequireViewById;
            ImageView imageView = (ImageView) viewRequireViewById.requireViewById(R.id.chooser_nearby_button);
            ImageView imageView2 = (ImageView) this.mConversationFacePile.requireViewById(R.id.chooser_header);
            ImageView imageView3 = (ImageView) this.mConversationFacePile.requireViewById(R.id.chooser_row_text_option);
