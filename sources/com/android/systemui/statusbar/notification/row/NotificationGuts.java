...
public class NotificationGuts extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        Drawable drawable = ((FrameLayout) this).mContext.getDrawable(com.android.systemui.R.drawable.notification_guts_bg);
    ...
    public void closeControls(int i, int i2, boolean z, boolean z2) {
        ...
        GutsContent gutsContent = this.mGutsContent;
        if (gutsContent == null || !gutsContent.handleCloseControls(z, z2) || zDismissCurrentBlockingHelper) {
    ...
    private void animateOpen(boolean z, int i, int i2, Runnable runnable) {
        ...
        if (z) {
            float fHypot = (float) Math.hypot(Math.max(getWidth() - i, i), Math.max(getHeight() - i2, i2));
            setAlpha(1.0f);
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(this, i, i2, 0.0f, fHypot);
    ...
    void animateClose(int i, int i2, boolean z) {
        ...
        if (z) {
            ...
            animatorCreateCircularReveal.setDuration(0L);
            animatorCreateCircularReveal.setInterpolator(Interpolators.FAST_OUT_LINEAR_IN);
            animatorCreateCircularReveal.addListener(new AnimateCloseListener(this, this.mGutsContent));
            animatorCreateCircularReveal.start();
            return;
        }
