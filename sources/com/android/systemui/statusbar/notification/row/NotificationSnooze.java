...
public class NotificationSnooze extends LinearLayout implements NotificationGuts.GutsContent, View.OnClickListener {
    ...
    ArrayList<NotificationSwipeActionHelper.SnoozeOption> getDefaultSnoozeOptions() throws Resources.NotFoundException {
        ...
        for (int i2 = 0; i2 < intArray.length; i2++) {
            ...
            int i3 = intArray[i2];
            NotificationSwipeActionHelper.SnoozeOption snoozeOptionCreateOption = createOption(i3, iArr[i2]);
            if (i2 == 0 || i3 == i) {
    ...
    private NotificationSwipeActionHelper.SnoozeOption createOption(int i, int i2) throws Resources.NotFoundException {
        ...
        int iIndexOf = str.indexOf(quantityString);
        if (iIndexOf == -1) {
            return new NotificationSnoozeOption(null, i, quantityString, str, accessibilityAction);
        }
        SpannableString spannableString = new SpannableString(str);
        spannableString.setSpan(new StyleSpan(1), iIndexOf, quantityString.length() + iIndexOf, 0);
    ...
    private void showSnoozeOptions(boolean z) {
        this.mExpandButton.setImageResource(z ? android.R.drawable.ic_ab_back_material_light : android.R.drawable.ic_bullet_key_permission);
        if (this.mExpanded != z) {
            this.mExpanded = z;
