...
public final class KeyboardShortcuts {
    ...
    private final int[] mModifierList = {65536, LineageHardwareManager.FEATURE_AUTO_CONTRAST, 2, 1, 4, 8};
    ...
    private void loadResources(Context context) {
        ...
        int i = com.android.systemui.R.string.keyboard_key_enter;
        ...
        int i2 = com.android.systemui.R.string.keyboard_key_button_template;
        ...
        int i3 = com.android.systemui.R.string.keyboard_key_numpad_template;
        ...
        this.mModifierNames.put(LineageHardwareManager.FEATURE_AUTO_CONTRAST, "Ctrl");
    ...
    static void sanitiseShortcuts(List<KeyboardShortcutGroup> list) {
        Iterator<KeyboardShortcutGroup> it = list.iterator();
        while (it.hasNext()) {
            Iterator<KeyboardShortcutInfo> it2 = it.next().getItems().iterator();
            while (it2.hasNext()) {
                it2.next().clearIcon();
            }
        }
    ...
    public KeyboardShortcutGroup getDefaultApplicationShortcuts() {
        ...
        if (assistComponentForUser != null) {
            ...
            if (packageInfo != null) {
                ...
                arrayList.add(new KeyboardShortcutInfo(this.mContext.getString(com.android.systemui.R.string.keyboard_shortcut_group_applications_assist), Icon.createWithResource(applicationInfo.packageName, applicationInfo.icon), 0, 65536));
            }
        }
    ...
    private void populateKeyboardShortcuts(LinearLayout linearLayout, List<KeyboardShortcutGroup> list) {
        ...
        while (i9 < size) {
            ...
            textView2.setTextColor(keyboardShortcutGroup2.isSystemGroup() ? Utils.getColorAccent(this.mContext) : ColorStateList.valueOf(this.mContext.getColor(com.android.systemui.R.color.ksh_application_group_color)));
            ...
            for (?? r12 = z2; r12 < size2; r12++) {
                KeyboardShortcutInfo keyboardShortcutInfo = keyboardShortcutGroup2.getItems().get(r12);
