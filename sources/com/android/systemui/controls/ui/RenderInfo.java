...
public final class RenderInfo {
    ...
    public static final class Companion {
        ...
        public final RenderInfo lookup(@NotNull Context context, @NotNull ComponentName componentName, int i, int i2) {
            ...
            int iIntValue3 = ((Number) MapsKt.getValue(RenderInfoKt.deviceIconMap, Integer.valueOf(i))).intValue();
            if (iIntValue3 == -1) {
                ...
                Drawable drawable2 = (Drawable) RenderInfo.iconMap.get(iIntValue3);
                if (drawable2 == null) {
                    drawable2 = context.getResources().getDrawable(iIntValue3, null);
                    RenderInfo.iconMap.put(iIntValue3, drawable2);
                }
                drawable = drawable2;
            }
            if (drawable == null) {
            ...
            Drawable drawableNewDrawable = drawable.getConstantState().newDrawable(context.getResources());
            Intrinsics.checkExpressionValueIsNotNull(drawableNewDrawable, "icon!!.constantState.new…awable(context.resources)");
            return new RenderInfo(drawableNewDrawable, iIntValue, iIntValue2);
        }
