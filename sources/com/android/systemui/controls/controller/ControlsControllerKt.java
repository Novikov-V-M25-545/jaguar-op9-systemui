...
public final class ControlsControllerKt {
    ...
    @NotNull
    public static final ControlsController.LoadData createLoadDataObject(@NotNull List<ControlStatus> allControls, @NotNull List<String> favorites, boolean z) {
        Intrinsics.checkParameterIsNotNull(allControls, "allControls");
