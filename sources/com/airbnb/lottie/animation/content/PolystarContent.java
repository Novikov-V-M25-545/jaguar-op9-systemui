        ...
        while (true) {
            ...
            if (d7 < dCeil) {
                ...
                if (fFloatValue4 == 0.0f && fFloatValue5 == 0.0f) {
                    ...
                    this.path.cubicTo(fCos - f15, fSin - f16, fCos3 + f18, fSin3 + f19, fCos3, fSin3);
                }
                d2 += f3;
                z = !z;
                i3++;
    ...
    private void createPolygonPath() {
        ...
        while (i2 < dCeil) {
            ...
            if (fFloatValue != 0.0f) {
                ...
                this.path.cubicTo(fCos - (fCos3 * f), fSin - (fSin3 * f), fCos2 + (((float) Math.cos(dAtan22)) * f), fSin2 + (f * ((float) Math.sin(dAtan22))), fCos2, fSin2);
            } else {
                d = d7;
                d2 = d5;
                d3 = d6;
