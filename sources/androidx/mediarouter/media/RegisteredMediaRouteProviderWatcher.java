...
final class RegisteredMediaRouteProviderWatcher {
    ...
    List<ServiceInfo> getMediaRoute2ProviderServices() {
        return (List) this.mPackageManager.queryIntentServices(new Intent("android.media.MediaRoute2ProviderService"), 0).stream().map(new Function() { // from class: androidx.mediarouter.media.RegisteredMediaRouteProviderWatcher$$ExternalSyntheticLambda0
