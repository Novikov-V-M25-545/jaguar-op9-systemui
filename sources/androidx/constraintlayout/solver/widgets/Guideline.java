...
public class Guideline extends ConstraintWidget {
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (this.mRelativeBegin != -1) {
            ...
            linearSystem.addEquality(solverVariableCreateObjectVariable, linearSystem.createObjectVariable(anchor), this.mRelativeBegin, 7);
            if (z) {
        ...
        linearSystem.addEquality(solverVariableCreateObjectVariable2, solverVariableCreateObjectVariable3, -this.mRelativeEnd, 7);
        if (z) {
