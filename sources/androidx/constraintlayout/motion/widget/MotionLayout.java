...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        public void measure(int i, int i2) {
            ...
            motionLayout3.mMeasureDuringTransition = (i3 == motionLayout3.mEndWrapWidth && motionLayout3.mStartWrapHeight == motionLayout3.mEndWrapHeight) ? false : true;
            int i4 = motionLayout3.mStartWrapHeight;
            if (motionLayout3.mWidthMeasureMode == Integer.MIN_VALUE) {
                i3 = (int) (i3 + (motionLayout3.mPostInterpolationPosition * (r5 - i3)));
            }
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if ((z2 || this.mModel.isNotConfiguredWith(startId, endId)) && this.mBeginState != -1) {
            ...
            if (this.mWidthMeasureMode == Integer.MIN_VALUE) {
                width = (int) (this.mStartWrapWidth + (this.mPostInterpolationPosition * (this.mEndWrapWidth - r5)));
                requestLayout();
            }
            if (this.mHeightMeasureMode == Integer.MIN_VALUE) {
                height = (int) (this.mStartWrapHeight + (this.mPostInterpolationPosition * (this.mEndWrapHeight - r5)));
                requestLayout();
            }
    ...
    /* JADX WARN: Removed duplicated region for block: B:131:0x01bb A[PHI: r9
  0x01bb: PHI (r9v10 boolean) = (r9v9 boolean), (r9v11 boolean), (r9v11 boolean) binds: [B:120:0x019e, B:127:0x01b1, B:129:0x01b7] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Removed duplicated region for block: B:63:0x00e2 A[PHI: r12
  0x00e2: PHI (r12v5 float) = (r12v4 float), (r12v6 float), (r12v6 float) binds: [B:49:0x00b2, B:59:0x00d6, B:61:0x00da] A[DONT_GENERATE, DONT_INLINE]] */
    /*
