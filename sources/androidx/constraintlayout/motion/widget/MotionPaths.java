...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i8, 1073741824);
        int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(i9, 1073741824);
        if (this.mLastMeasuredWidth != iMakeMeasureSpec || this.mLastMeasuredHeight != iMakeMeasureSpec2) {
            z4 = z3;
        }
        if (z4) {
            this.mLastMeasuredWidth = iMakeMeasureSpec;
            this.mLastMeasuredHeight = iMakeMeasureSpec2;
