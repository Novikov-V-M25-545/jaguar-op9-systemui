...
public abstract class ConstraintHelper extends View {
    ...
    private void addID(String str) throws Resources.NotFoundException {
        ...
        int identifier = 0;
        if (isInEditMode() && constraintLayout != null && (designInformation = constraintLayout.getDesignInformation(0, strTrim)) != null && (designInformation instanceof Integer)) {
    ...
    protected void setIds(String str) throws Resources.NotFoundException {
    ...
    protected void applyLayoutFeatures(ConstraintLayout constraintLayout) throws Resources.NotFoundException {
    ...
    protected void applyLayoutFeatures() throws Resources.NotFoundException {
