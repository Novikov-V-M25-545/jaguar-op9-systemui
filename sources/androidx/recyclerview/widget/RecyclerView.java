        ...
        this.mChildHelper = new ChildHelper(new ChildHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.5
            ...
            public void detachViewFromParent(int i) {
                ...
                if (childAt != null && (childViewHolderInt = RecyclerView.getChildViewHolderInt(childAt)) != null) {
                    ...
                    childViewHolderInt.addFlags(LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT);
                }
  ...
  0x00df: PHI (r0v36 int) = (r0v26 int), (r0v40 int) binds: [B:41:0x00c8, B:45:0x00db] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    ...
    private void dispatchContentChangedIfNecessary() {
        ...
        accessibilityEventObtain.setEventType(LineageHardwareManager.FEATURE_TOUCH_HOVERING);
        ...
        if (this.mState.mRunPredictiveAnimations) {
            ...
            for (int i2 = 0; i2 < this.mChildHelper.getChildCount(); i2++) {
                ...
                if (!childViewHolderInt2.shouldIgnore() && !this.mViewInfoStore.isInPreLayout(childViewHolderInt2)) {
                    ...
                    boolean zHasAnyOfTheFlags = childViewHolderInt2.hasAnyOfTheFlags(LineageHardwareManager.FEATURE_DISPLAY_MODES);
                    if (!zHasAnyOfTheFlags) {
                        iBuildAdapterChangeFlagsForAnimations |= LineageHardwareManager.FEATURE_AUTO_CONTRAST;
                    }
    ...
    void recordAnimationInfoIfBouncedHiddenView(ViewHolder viewHolder, ItemAnimator.ItemHolderInfo itemHolderInfo) {
        viewHolder.setFlags(0, LineageHardwareManager.FEATURE_DISPLAY_MODES);
  ...
  0x012c: PHI (r4v3 boolean) = (r4v2 boolean), (r4v7 boolean) binds: [B:28:0x005d, B:45:0x00ad] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    public static abstract class ViewHolder {
        ...
        boolean isTmpDetached() {
            return (this.mFlags & LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT) != 0;
        }
        ...
        void addChangePayload(Object obj) {
            if (obj == null) {
                addFlags(LineageHardwareManager.FEATURE_VIBRATOR);
        ...
        List<Object> getUnmodifiedPayloads() {
            if ((this.mFlags & LineageHardwareManager.FEATURE_VIBRATOR) == 0) {
                List<Object> list = this.mPayloads;
    ...
    public static abstract class ItemAnimator {
        ...
        static int buildAdapterChangeFlagsForAnimations(ViewHolder viewHolder) {
            ...
            return (oldPosition == -1 || absoluteAdapterPosition == -1 || oldPosition == absoluteAdapterPosition) ? i : i | LineageHardwareManager.FEATURE_TOUCH_HOVERING;
        }
