...
public class ArrayMap<K, V> extends SimpleArrayMap<K, V> implements Map<K, V> {
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            ...
            int iIndexOfKey = ArrayMap.this.indexOfKey(entry.getKey());
            if (iIndexOfKey < 0) {
                return false;
            }
            return ContainerHelpers.equal(ArrayMap.this.valueAt(iIndexOfKey), entry.getValue());
        }
        ...
        public int hashCode() {
            ...
            for (int i = ArrayMap.this.mSize - 1; i >= 0; i--) {
                ...
                V vValueAt = ArrayMap.this.valueAt(i);
                iHashCode += (kKeyAt == null ? 0 : kKeyAt.hashCode()) ^ (vValueAt == null ? 0 : vValueAt.hashCode());
            }
            return iHashCode;
        }
    }
