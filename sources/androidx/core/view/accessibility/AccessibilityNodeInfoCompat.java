...
public class AccessibilityNodeInfoCompat {
    ...
    private static String getActionSymbolicName(int i) {
        ...
        switch (i) {
            ...
            case LineageHardwareManager.FEATURE_KEY_SWAP /* 64 */:
                return "ACTION_ACCESSIBILITY_FOCUS";
            case 128:
                return "ACTION_CLEAR_ACCESSIBILITY_FOCUS";
            case LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT /* 256 */:
                return "ACTION_NEXT_AT_MOVEMENT_GRANULARITY";
            case 512:
                return "ACTION_PREVIOUS_AT_MOVEMENT_GRANULARITY";
            case LineageHardwareManager.FEATURE_VIBRATOR /* 1024 */:
                return "ACTION_NEXT_HTML_ELEMENT";
            case LineageHardwareManager.FEATURE_TOUCH_HOVERING /* 2048 */:
                return "ACTION_PREVIOUS_HTML_ELEMENT";
            case LineageHardwareManager.FEATURE_AUTO_CONTRAST /* 4096 */:
                return "ACTION_SCROLL_FORWARD";
            case LineageHardwareManager.FEATURE_DISPLAY_MODES /* 8192 */:
                return "ACTION_SCROLL_BACKWARD";
            case LineageHardwareManager.FEATURE_READING_ENHANCEMENT /* 16384 */:
                return "ACTION_COPY";
            case 32768:
                return "ACTION_PASTE";
            case 65536:
    ...
    public static class AccessibilityActionCompat {
        ...
        public static final AccessibilityActionCompat ACTION_NEXT_AT_MOVEMENT_GRANULARITY = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT, null, AccessibilityViewCommand.MoveAtGranularityArguments.class);
        ...
        public static final AccessibilityActionCompat ACTION_NEXT_HTML_ELEMENT = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_VIBRATOR, null, AccessibilityViewCommand.MoveHtmlArguments.class);
        public static final AccessibilityActionCompat ACTION_PREVIOUS_HTML_ELEMENT = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_TOUCH_HOVERING, null, AccessibilityViewCommand.MoveHtmlArguments.class);
        public static final AccessibilityActionCompat ACTION_SCROLL_FORWARD = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_AUTO_CONTRAST, null);
        public static final AccessibilityActionCompat ACTION_SCROLL_BACKWARD = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_DISPLAY_MODES, null);
        public static final AccessibilityActionCompat ACTION_COPY = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_READING_ENHANCEMENT, null);
        public static final AccessibilityActionCompat ACTION_PASTE = new AccessibilityActionCompat(32768, null);
        public static final AccessibilityActionCompat ACTION_CUT = new AccessibilityActionCompat(65536, null);
        public static final AccessibilityActionCompat ACTION_SET_SELECTION = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_COLOR_BALANCE, null, AccessibilityViewCommand.SetSelectionArguments.class);
        public static final AccessibilityActionCompat ACTION_EXPAND = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_PICTURE_ADJUSTMENT, null);
        public static final AccessibilityActionCompat ACTION_COLLAPSE = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_TOUCHSCREEN_GESTURES, null);
        public static final AccessibilityActionCompat ACTION_DISMISS = new AccessibilityActionCompat(1048576, null);
        public static final AccessibilityActionCompat ACTION_SET_TEXT = new AccessibilityActionCompat(LineageHardwareManager.FEATURE_ANTI_FLICKER, null, AccessibilityViewCommand.SetTextArguments.class);
