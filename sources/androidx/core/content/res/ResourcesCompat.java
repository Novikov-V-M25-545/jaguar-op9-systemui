...
public final class ResourcesCompat {
    ...
    public static ColorStateList getColorStateList(Resources resources, int i, Resources.Theme theme) throws Resources.NotFoundException {
        ...
        if (colorStateListInflateColorStateList != null) {
            addColorStateListToCache(resources, i, colorStateListInflateColorStateList);
    ...
    private static void addColorStateListToCache(Resources resources, int i, ColorStateList colorStateList) {
        synchronized (sColorStateCacheLock) {
            WeakHashMap<Resources, SparseArray<ColorStateListCacheEntry>> weakHashMap = sColorStateCaches;
            SparseArray<ColorStateListCacheEntry> sparseArray = weakHashMap.get(resources);
            if (sparseArray == null) {
                sparseArray = new SparseArray<>();
                weakHashMap.put(resources, sparseArray);
            }
            ...
            */
            static void rebase(android.content.res.Resources.Theme r6) {
                /*
                    ...
                    monitor-enter(r0)
                    boolean r1 = androidx.core.content.res.ResourcesCompat.ThemeCompat.ImplApi23.sRebaseMethodFetched     // Catch: java.lang.Throwable -> L3a
                    r2 = 0
                    if (r1 != 0) goto L23
                    r1 = 1
                    ...
                    androidx.core.content.res.ResourcesCompat.ThemeCompat.ImplApi23.sRebaseMethod = r3     // Catch: java.lang.NoSuchMethodException -> L19 java.lang.Throwable -> L3a
                ...
                L21:
                    androidx.core.content.res.ResourcesCompat.ThemeCompat.ImplApi23.sRebaseMethodFetched = r1     // Catch: java.lang.Throwable -> L3a
                L23:
                    java.lang.reflect.Method r1 = androidx.core.content.res.ResourcesCompat.ThemeCompat.ImplApi23.sRebaseMethod     // Catch: java.lang.Throwable -> L3a
                    if (r1 == 0) goto L38
                ...
                L2d:
                    ...
                    r6 = 0
                    androidx.core.content.res.ResourcesCompat.ThemeCompat.ImplApi23.sRebaseMethod = r6     // Catch: java.lang.Throwable -> L3a
                L38:
