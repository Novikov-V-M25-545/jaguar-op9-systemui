...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    public void onWindowSystemUiVisibilityChanged(int i) {
        ...
        boolean z = (i & 4) == 0;
        boolean z2 = (i & LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT) != 0;
        ...
        if ((i2 & LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT) == 0 || this.mActionBarVisibilityCallback == null) {
            return;
        }
        ViewCompat.requestApplyInsets(this);
    }
    ...
    */
    ...
    protected void onMeasure(int i, int i2) {
        ...
        boolean z = (ViewCompat.getWindowSystemUiVisibility(this) & LineageHardwareManager.FEATURE_SUNLIGHT_ENHANCEMENT) != 0;
        if (z) {
