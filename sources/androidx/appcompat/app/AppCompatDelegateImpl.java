...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private AppCompatDelegateImpl(Context context, Window window, AppCompatCallback appCompatCallback, Object obj) {
        ...
        this.mInvalidatePanelMenuRunnable = new Runnable() { // from class: androidx.appcompat.app.AppCompatDelegateImpl.2
            ...
            public void run() {
                ...
                if ((appCompatDelegateImpl2.mInvalidatePanelMenuFeatures & LineageHardwareManager.FEATURE_AUTO_CONTRAST) != 0) {
    ...
    */
    ...
    private void updateStatusGuardColor(View view) {
        int color;
        if ((ViewCompat.getWindowSystemUiVisibility(view) & LineageHardwareManager.FEATURE_DISPLAY_MODES) != 0) {
