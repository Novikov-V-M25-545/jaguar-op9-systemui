...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    private int mShortcutNumericModifiers = LineageHardwareManager.FEATURE_AUTO_CONTRAST;
    private int mShortcutAlphabeticModifiers = LineageHardwareManager.FEATURE_AUTO_CONTRAST;
    ...
    String getShortcutLabel() {
        ...
        appendModifier(sb, i, LineageHardwareManager.FEATURE_AUTO_CONTRAST, resources.getString(R$string.abc_menu_ctrl_shortcut_label));
