...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public void draw(Canvas canvas) {
        ...
        int iMin = Math.min(LineageHardwareManager.FEATURE_TOUCH_HOVERING, (int) (this.mTmpBounds.width() * fAbs));
        int iMin2 = Math.min(LineageHardwareManager.FEATURE_TOUCH_HOVERING, (int) (this.mTmpBounds.height() * fAbs2));
        if (iMin <= 0 || iMin2 <= 0) {
            return;
        }
    ...
    static VectorDrawableCompat createWithoutDelegate(Resources resources, int i, Resources.Theme theme) throws XmlPullParserException, Resources.NotFoundException, IOException {
        int next;
        try {
