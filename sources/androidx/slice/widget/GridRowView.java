...
public class GridRowView extends SliceChildView implements View.OnClickListener, View.OnTouchListener {
    ...
    private void addCell(GridContent.CellContent cellContent, int i, int i2) {
        ...
        String str;
        int i6 = (getMode() == 1 && this.mGridContent.hasImage()) ? 1 : 2;
        LinearLayout linearLayout = new LinearLayout(getContext());
        ...
        while (i9 < cellItems.size()) {
            ...
            int iDeterminePadding = determinePadding(sliceItem2);
            if (i8 < i6 && (str2.equals(format) || "long".equals(format))) {
                if (arrayList == null || arrayList.contains(sliceItem3)) {
                    ...
                    str = str2;
                    if (addItem(sliceItem3, this.mTintColor, linearLayout, iDeterminePadding, z)) {
                        i8 = i4 + 1;
                ...
                arrayList2 = arrayList;
                str = str2;
                if (i3 < 1 && "image".equals(sliceItem3.getFormat()) && addItem(sliceItem3, this.mTintColor, linearLayout, 0, z)) {
                    i7 = i3 + 1;
                    sliceItem2 = sliceItem3;
                    i8 = i4;
                    z2 = true;
    ...
    private boolean addItem(SliceItem sliceItem, int i, ViewGroup viewGroup, int i2, boolean z) {
        ...
        if ("text".equals(format) || "long".equals(format)) {
            boolean zHasAnyHints = SliceQuery.hasAnyHints(sliceItem, "large", "title");
            TextView textView2 = (TextView) LayoutInflater.from(getContext()).inflate(zHasAnyHints ? TITLE_TEXT_LAYOUT : TEXT_LAYOUT, (ViewGroup) null);
            if (this.mSliceStyle != null) {
                textView2.setTextSize(0, zHasAnyHints ? r12.getGridTitleSize() : r12.getGridSubtitleSize());
                textView2.setTextColor(zHasAnyHints ? this.mSliceStyle.getTitleColor() : this.mSliceStyle.getSubtitleColor());
            }
            ...
            textView2.setText(sanitizedText);
            viewGroup.addView(textView2);
            textView2.setPadding(0, i2, 0, 0);
            textView = textView2;
        } else if ("image".equals(format) && sliceItem.getIcon() != null && (drawableLoadDrawable = sliceItem.getIcon().loadDrawable(getContext())) != null) {
            ...
            if (sliceItem.hasHint("raw")) {
                ...
                if (sliceItem.hasHint("large")) {
                    ...
                    int i3 = !z2 ? this.mSmallImageSize : this.mIconSize;
    ...
    private void makeEntireGridClickable(boolean z) {
        ...
        this.mForeground.setBackground(z ? SliceViewUtil.getDrawable(getContext(), R.attr.selectableItemBackground) : null);
    ...
    private void makeClickable(View view, boolean z) {
        ...
        view.setBackground(z ? SliceViewUtil.getDrawable(getContext(), i) : null);
        view.setClickable(z);
    }
    ...
    public void onClick(View view) {
        ...
        if (sliceItem == null || (sliceItemFind = SliceQuery.find(sliceItem, "action", (String) null, (String) null)) == null) {
            return;
        }
        try {
            sliceItemFind.fireAction(null, null);
            SliceView.OnSliceActionListener onSliceActionListener = this.mObserver;
            if (onSliceActionListener != null) {
                onSliceActionListener.onSliceAction(eventInfo, sliceItemFind);
            }
