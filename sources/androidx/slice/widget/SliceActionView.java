    ...
    public void setAction(SliceActionImpl sliceActionImpl, EventInfo eventInfo, SliceView.OnSliceActionListener onSliceActionListener, int i, SliceActionLoadingListener sliceActionLoadingListener) {
        ...
        if (sliceActionImpl.isDefaultToggle()) {
            ...
            if (i != -1) {
                ...
                Drawable drawableWrap = DrawableCompat.wrap(r9.getTrackDrawable());
                DrawableCompat.setTintList(drawableWrap, colorStateList);
                r9.setTrackDrawable(drawableWrap);
                ...
                Drawable drawableWrap2 = DrawableCompat.wrap(r9.getThumbDrawable());
                DrawableCompat.setTintList(drawableWrap2, colorStateList2);
                r9.setThumbDrawable(drawableWrap2);
            }
            this.mActionView = r9;
            ...
            Drawable drawableLoadDrawable = this.mSliceAction.getIcon().loadDrawable(getContext());
            ((ImageView) this.mActionView).setImageDrawable(drawableLoadDrawable);
            if (i != -1 && this.mSliceAction.getImageMode() == 0 && drawableLoadDrawable != null) {
                DrawableCompat.setTint(drawableLoadDrawable, i);
            }
            ...
            int i3 = sliceActionImpl.getImageMode() == 0 ? this.mIconSize / 2 : 0;
    ...
    private void sendActionInternal() {
        ...
        try {
            if (this.mSliceAction.isToggle()) {
                ...
                Intent intentPutExtra = new Intent().addFlags(268435456).putExtra("android.app.slice.extra.TOGGLE_STATE", zIsChecked);
