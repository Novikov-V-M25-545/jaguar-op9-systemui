...
public class RemoteInputView extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    void sendRemoteInput() {
        ...
        try {
            this.mAction.fireAction(getContext(), intentAddFlags);
            reset();
    ...
    public static class RemoteEditText extends EditText {
        ...
        public InputConnection onCreateInputConnection(EditorInfo editorInfo) {
            ...
            if (this.mShowImeOnInputConnection && inputConnectionOnCreateInputConnection != null && (inputMethodManager = (InputMethodManager) ContextCompat.getSystemService(getContext(), InputMethodManager.class)) != null) {
