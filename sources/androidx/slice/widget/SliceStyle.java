...
public class SliceStyle {
    ...
    public SliceStyle(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        try {
            int color = typedArrayObtainStyledAttributes.getColor(R$styleable.SliceView_tintColor, -1);
            if (color == -1) {
                color = this.mTintColor;
            }
            this.mTintColor = color;
            this.mTitleColor = typedArrayObtainStyledAttributes.getColor(R$styleable.SliceView_titleColor, 0);
            this.mSubtitleColor = typedArrayObtainStyledAttributes.getColor(R$styleable.SliceView_subtitleColor, 0);
            this.mHeaderTitleSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_headerTitleSize, 0.0f);
            this.mHeaderSubtitleSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_headerSubtitleSize, 0.0f);
            this.mVerticalHeaderTextPadding = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_headerTextVerticalPadding, 0.0f);
            this.mTitleSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_titleSize, 0.0f);
            this.mSubtitleSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_subtitleSize, 0.0f);
            this.mVerticalTextPadding = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_textVerticalPadding, 0.0f);
            this.mGridTitleSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_gridTitleSize, 0.0f);
            this.mGridSubtitleSize = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_gridSubtitleSize, 0.0f);
            this.mVerticalGridTextPadding = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_gridTextVerticalPadding, context.getResources().getDimensionPixelSize(R$dimen.abc_slice_grid_text_inner_padding));
            this.mGridTopPadding = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_gridTopPadding, 0.0f);
            this.mGridBottomPadding = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_gridBottomPadding, 0.0f);
            int resourceId = typedArrayObtainStyledAttributes.getResourceId(R$styleable.SliceView_rowStyle, 0);
            if (resourceId != 0) {
                this.mRowStyle = new RowStyle(context, resourceId);
            }
            this.mRowMaxHeight = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_rowMaxHeight, context.getResources().getDimensionPixelSize(R$dimen.abc_slice_row_max_height));
            this.mRowRangeHeight = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_rowRangeHeight, context.getResources().getDimensionPixelSize(R$dimen.abc_slice_row_range_height));
            this.mRowSingleTextWithRangeHeight = (int) typedArrayObtainStyledAttributes.getDimension(R$styleable.SliceView_rowRangeSingleTextHeight, context.getResources().getDimensionPixelSize(R$dimen.abc_slice_row_range_single_text_height));
            ...
            this.mRowMinHeight = resources.getDimensionPixelSize(i3);
            ...
            this.mListMinScrollHeight = resources.getDimensionPixelSize(i3);
    ...
    public int getGridHeight(GridContent gridContent, SliceViewPolicy sliceViewPolicy) {
        ...
        if (gridContent.isAllImages()) {
            if (gridContent.getGridContent().size() == 1) {
                i = z2 ? this.mGridBigPicMinHeight : this.mGridBigPicMaxHeight;
            ...
            boolean zHasImage = gridContent.hasImage();
            if (largestImageMode != 0 && largestImageMode != 5) {
                z = false;
            }
            if (z3 && !z2) {
                i = zHasImage ? this.mGridMaxHeight : this.mGridMinHeight;
            } else {
    ...
    public int getListHeight(ListContent listContent, SliceViewPolicy sliceViewPolicy) {
        ...
        boolean zIsScrollable = sliceViewPolicy.isScrollable();
        ...
        return !zIsScrollable ? getListItemsHeight(getListItemsForNonScrollingList(listContent, listItemsHeight, sliceViewPolicy), sliceViewPolicy) : listItemsHeight;
    }
