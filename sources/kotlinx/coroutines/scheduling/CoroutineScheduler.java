...
public final class CoroutineScheduler implements Executor, Closeable {
    ...
    static {
        ...
        MIN_PARK_TIME_NS = (int) RangesKt___RangesKt.coerceAtMost(RangesKt___RangesKt.coerceAtLeast(TasksKt.WORK_STEALING_TIME_RESOLUTION_NS / 4, 10L), nanos);
    ...
    */
    ...
    public final void dispatch(@NotNull Runnable block, @NotNull TaskContext taskContext, boolean z) {
        ...
        int iSubmitToLocalQueue = submitToLocalQueue(taskCreateTask$kotlinx_coroutines_core, z);
    ...
    public final class Worker extends Thread {
        ...
        private final void beforeTask(TaskMode taskMode, long j) {
            if (taskMode == TaskMode.NON_BLOCKING) {
                ...
                if (j2 < j3 || jNanoTime - this.lastExhaustionTime < j3 * 5) {
                    return;
                }
