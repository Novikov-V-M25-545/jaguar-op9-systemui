        ...
        try {
            ...
            try {
                ...
                if (exceptionalResult$kotlinx_coroutines_core == null && job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m407constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(cancellationException, continuation))));
                    ...
                    continuation.resumeWith(Result.m407constructorimpl(successfulResult$kotlinx_coroutines_core));
                } else {
                    Result.Companion companion3 = Result.Companion;
                    continuation.resumeWith(Result.m407constructorimpl(ResultKt.createFailure(StackTraceRecoveryKt.recoverStackTrace(exceptionalResult$kotlinx_coroutines_core, continuation))));
                }
                Unit unit = Unit.INSTANCE;
                try {
                    Result.Companion companion4 = Result.Companion;
                    taskContext.afterTask();
                    objM407constructorimpl2 = Result.m407constructorimpl(unit);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.Companion;
                    objM407constructorimpl2 = Result.m407constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException$kotlinx_coroutines_core(null, Result.m409exceptionOrNullimpl(objM407constructorimpl2));
            } finally {
            ...
            try {
                ...
                taskContext.afterTask();
                objM407constructorimpl = Result.m407constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.Companion;
                objM407constructorimpl = Result.m407constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException$kotlinx_coroutines_core(th2, Result.m409exceptionOrNullimpl(objM407constructorimpl));
        }
    }
}
